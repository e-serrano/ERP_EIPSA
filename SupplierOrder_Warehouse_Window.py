...
# Function to load table of orders
    def loadtableorders(self):
        commands_querytableorders = ("""
                        SELECT purch_fact.supplier_ord_header.id,
                        purch_fact.supplier_ord_header.supplier_order_num,
                        purch_fact.suppliers."name",
                        TO_CHAR(purch_fact.supplier_ord_header."order_date",'DD-MM-YYYY'),
                        TO_CHAR(purch_fact.supplier_ord_header.delivery_date,'DD-MM-YYYY'),
                        purch_fact.supplier_ord_header.their_ref,
                        purch_fact.supplier_ord_header.notes, purch_fact.supplier_ord_header.delivery_term,
                        purch_fact.supplier_ord_header.delivery_way, purch_fact.supplier_ord_header.order_com,
                        purch_fact.supplier_ord_header.final_comment, purch_fact.supplier_ord_header.pay_way,
                        TO_CHAR(purch_fact.supplier_ord_header.deliv_date_1,'DD-MM-YYYY'), purch_fact.supplier_ord_header.deliv_note_1,
                        TO_CHAR(purch_fact.supplier_ord_header.deliv_date_2,'DD-MM-YYYY'), purch_fact.supplier_ord_header.deliv_note_2,
                        TO_CHAR(purch_fact.supplier_ord_header.deliv_date_3,'DD-MM-YYYY'), purch_fact.supplier_ord_header.deliv_note_3
                        FROM purch_fact.supplier_ord_header
                        LEFT JOIN purch_fact.suppliers ON (purch_fact.suppliers."id" = purch_fact.supplier_ord_header."supplier_id")
                        ORDER BY purch_fact.supplier_ord_header.id
                        """)
        conn = None
        try:
        # read the connection parameters
