...
class Ui_TAGQueryOthers_Window(QtWidgets.QMainWindow):
    ...
    def querytags(self):
        self.tableTags.setRowCount(0)
        query_material = ("""
                        SELECT tags."tag", tags."num_offer", tags."num_order", tags."amount", tags."dim_drawing", tags."of_drawing"
        ...
        # fill the Qt Table with the query results
            ...
            column_headers = ['TAG', 'Nº Oferta', 'Nº Pedido', 'Precio', 'Nº Plano Dim.', 'Nº Plano OF']
