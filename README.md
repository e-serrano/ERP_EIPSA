Este es una aplicación ERP creada para una empresa de producción industrial partícular, basado en un sistema de roles para los usuarios, donde cada rol tiene unas funcionalidades propias.
