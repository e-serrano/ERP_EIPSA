# Form implementation generated from reading ui file 'PurchasingDetailQuery_Window.ui'
#
...
class Ui_PurchasingDetailQuery_Window(QtWidgets.QMainWindow):
    """
    UI class for the Purchasing Order from supplier detail window.
    """
    def __init__(self, id):
        """
        Initializes the Ui_New_Offer_Window with the specified id.

        Args:
            id (str): id associated with the window.
        """
        super().__init__()
        self.purchase_id = id
        self.setupUi(self)

    def setupUi(self, PurchasingDetailQuery_Window):
        PurchasingDetailQuery_Window.setObjectName("PurchasingDetailQuery_Window")
        PurchasingDetailQuery_Window.resize(845, 590)
        PurchasingDetailQuery_Window.setMinimumSize(QtCore.QSize(1000, 590))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        PurchasingDetailQuery_Window.setWindowIcon(icon)
        PurchasingDetailQuery_Window.setStyleSheet("QWidget {\n"
...
"    border-color: rgb(255, 255, 255);\n"
"}")
        self.centralwidget = QtWidgets.QWidget(parent=PurchasingDetailQuery_Window)
        ...
        self.tableQueryPurchase.setColumnCount(9)
        ...
        self.gridLayout_2.addWidget(self.tableQueryPurchase, 1, 0, 1, 11)
        ...
        PurchasingDetailQuery_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=PurchasingDetailQuery_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 845, 22))
        self.menubar.setObjectName("menubar")
        PurchasingDetailQuery_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=PurchasingDetailQuery_Window)
        self.statusbar.setObjectName("statusbar")
        PurchasingDetailQuery_Window.setStatusBar(self.statusbar)
        self.tableQueryPurchase.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)

        self.retranslateUi(PurchasingDetailQuery_Window)
        QtCore.QMetaObject.connectSlotsByName(PurchasingDetailQuery_Window)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, PurchasingDetailQuery_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        PurchasingDetailQuery_Window.setWindowTitle(_translate("PurchasingDetailQuery_Window", "Consultar Compras"))
        item = self.tableQueryPurchase.horizontalHeaderItem(0)
        item.setText(_translate("PurchasingDetailQuery_Window", "Material"))
        item = self.tableQueryPurchase.horizontalHeaderItem(1)
        item.setText(_translate("PurchasingDetailQuery_Window", "Cantidad"))
        item = self.tableQueryPurchase.horizontalHeaderItem(2)
        item.setText(_translate("PurchasingDetailQuery_Window", "Pendiente"))
        item = self.tableQueryPurchase.horizontalHeaderItem(3)
        item.setText(_translate("PurchasingDetailQuery_Window", "Cantidad Entrega 1"))
        item = self.tableQueryPurchase.horizontalHeaderItem(4)
        item.setText(_translate("PurchasingDetailQuery_Window", "Fecha Entrega 1"))
        item = self.tableQueryPurchase.horizontalHeaderItem(5)
        item.setText(_translate("PurchasingDetailQuery_Window", "Cantidad Entrega 2"))
        item = self.tableQueryPurchase.horizontalHeaderItem(6)
        item.setText(_translate("PurchasingDetailQuery_Window", "Fecha Entrega 2"))
        item = self.tableQueryPurchase.horizontalHeaderItem(7)
        item.setText(_translate("PurchasingDetailQuery_Window", "Cantidad Entrega 3"))
        item = self.tableQueryPurchase.horizontalHeaderItem(8)
        item.setText(_translate("PurchasingDetailQuery_Window", "Fecha Entrega 3"))
    ...
    def query_all(self):
        """
        Queries the database for suppliers order items of determined supplier order, configures and populates tables with the query results, 
        and updates the UI accordingly. Handles potential database errors and updates the UI with appropriate messages.
        """
        self.tableQueryPurchase.setRowCount(0)

        commands_query_all = ("""
                        (SELECT supplies."description", purchase_detail."quantity", purchase_detail."pending", purchase_detail."deliv_quant_1", TO_CHAR(purchase_detail."deliv_date_1",'dd/MM/yyyy'),
                        purchase_detail."deliv_quant_2", TO_CHAR(purchase_detail."deliv_date_2",'dd/MM/yyyy'), purchase_detail."deliv_quant_3", TO_CHAR(purchase_detail."deliv_date_3",'dd/MM/yyyy')
                        FROM purch_fact.supplier_ord_detail AS purchase_detail
                        INNER JOIN purch_fact.supplies AS supplies ON purchase_detail."supply_id" = supplies."id"
                        WHERE purchase_detail."supplier_ord_header_id" = %s
        ...
        # execution of commands
            cur.execute(commands_query_all, (self.purchase_id,))
        ...
        # fill the Qt Table with the query results
            ...
            self.tableQueryPurchase.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)
            self.tableQueryPurchase.horizontalHeader().setSectionResizeMode(0, QtWidgets.QHeaderView.ResizeMode.ResizeToContents)
...
if __name__ == "__main__":
    ...
    PurchasingDetailQuery_Window = Ui_PurchasingDetailQuery_Window()
    PurchasingDetailQuery_Window.show()
    sys.exit(app.exec())
