...
class Ui_InvoiceGeneralQuery_Window(QtWidgets.QMainWindow):
    """
    UI class for the Invoice General Query window.
    """
    def __init__(self):
        """
        Initializes the Ui_InvoiceGeneralQuery_Window.
        """
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, InvoiceGeneralQuery_Window):
        """
        Sets up the user interface for the InvoiceGeneralQuery_Window.

        Args:
            InvoiceGeneralQuery_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
