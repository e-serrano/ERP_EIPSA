...
class Ui_Edit_Offer_Window(object):
    def setupUi(self, Edit_Offer):
        ...
        Edit_Offer.resize(670, 425)
        Edit_Offer.setMinimumSize(QtCore.QSize(670, 425))
        Edit_Offer.setMaximumSize(QtCore.QSize(670, 425))
        icon = QtGui.QIcon()
...
"}"
    ...
    def retranslateUi(self, Edit_Offer):
        ...
        self.label_NumOffer.setText(_translate("Edit_Offer", "Nº Oferta:"))
        self.label_Client.setText(_translate("Edit_Offer", "Cliente:"))
        self.label_FinalClient.setText(_translate("Edit_Offer", "Cliente Final:"))
        self.label_NumRef.setText(_translate("Edit_Offer", "Nº Referencia:"))
        self.label_State.setText(_translate("Edit_Offer", "Estado:"))
        self.label_NacExt.setText(_translate("Edit_Offer", "Nacional/Exterior:"))
        self.label_Buyer.setText(_translate("Edit_Offer", "Comprador:"))
        self.label_Material.setText(_translate("Edit_Offer", "Material:"))
        self.label_Notes.setText(_translate("Edit_Offer", "Notas:"))
        self.label_Amount.setText(_translate("Edit_Offer", "Importe (€):"))


        self.Material_EditOffer.setItemText(0, _translate("Edit_Offer", "Material1"))
        self.Material_EditOffer.setItemText(1, _translate("Edit_Offer", "Material2"))
        self.Button_EditOffer.setText(_translate("Edit_Offer", "Editar Oferta"))
