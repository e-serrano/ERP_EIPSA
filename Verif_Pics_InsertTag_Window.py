# Form implementation generated from reading ui file 'Verif_Pics_InsertTag_Window.ui'
#
...
class Ui_Verif_Pics_InsertTag_Window(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Verif_Pics_InsertTag_Window):
        Verif_Pics_InsertTag_Window.setObjectName("Verif_Pics_InsertTag_Window")
        Verif_Pics_InsertTag_Window.resize(400, 561)
        Verif_Pics_InsertTag_Window.setMinimumSize(QtCore.QSize(1000, 675))
        # Verif_Pics_InsertTag_Window.setMaximumSize(QtCore.QSize(800, 675))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Verif_Pics_InsertTag_Window.setWindowIcon(icon)
        if self.username == 'm.gil':
            Verif_Pics_InsertTag_Window.setStyleSheet("QWidget {\n"
    ...
    "    border-color: rgb(255, 255, 255);\n"
    "}")
        self.centralwidget = QtWidgets.QWidget(parent=Verif_Pics_InsertTag_Window)
...
"}")
        ...
        Verif_Pics_InsertTag_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Verif_Pics_InsertTag_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 400, 22))
        self.menubar.setObjectName("menubar")
        Verif_Pics_InsertTag_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Verif_Pics_InsertTag_Window)
        self.statusbar.setObjectName("statusbar")
        Verif_Pics_InsertTag_Window.setStatusBar(self.statusbar)
        ...
        Verif_Pics_InsertTag_Window.setWindowFlag(QtCore.Qt.WindowType.WindowCloseButtonHint, False)

        self.retranslateUi(Verif_Pics_InsertTag_Window)
        QtCore.QMetaObject.connectSlotsByName(Verif_Pics_InsertTag_Window)

        self.num_order.setText(self.numorder)

        self.Button_Cancel.clicked.connect(Verif_Pics_InsertTag_Window.close)
                ...
                if len(id_list) == 0:
                    ...
                    # execution of commands
                        for id_value in id_list:
                            commands_liquidtest = f"UPDATE {self.table_name} SET tag_images = '{tag_images}' WHERE {self.column_id} = {id_value}"
