...
"}")
    ...
    def querytags(self):
        query_tags = ("""
                        SELECT num_order, tag, item_type, of_drawing, NULL as of_sensor_drawing, TO_CHAR(ph1_date, 'DD/MM/YYYY'), ph1_manometer, ph1_pressure, ph1_state, ph1_obs, TO_CHAR(ph2_date, 'DD/MM/YYYY'), ph2_manometer, ph2_pressure, ph2_state, ph2_obs FROM tags_data.tags_flow WHERE ph1_date IS NOT NULL
                        UNION
                        SELECT num_order, tag, item_type, of_drawing, of_sensor_drawing, TO_CHAR(ph1_date, 'DD/MM/YYYY'), ph1_manometer, ph1_pressure, ph1_state, ph1_obs, TO_CHAR(ph2_date, 'DD/MM/YYYY'), ph2_manometer, ph2_pressure, ph2_state, ph2_obs FROM tags_data.tags_temp WHERE ph1_date IS NOT NULL
                        UNION
                        SELECT num_order, tag, item_type, of_drawing, NULL as of_sensor_drawing, TO_CHAR(ph1_date, 'DD/MM/YYYY'), ph1_manometer, ph1_pressure, ph1_state, ph1_obs, TO_CHAR(ph2_date, 'DD/MM/YYYY'), ph2_manometer, ph2_pressure, ph2_state, ph2_obs FROM tags_data.tags_level WHERE ph1_date IS NOT NULL
                        UNION
                        SELECT num_order, tag, item_type, NULL as of_drawing, NULL as of_sensor_drawing, TO_CHAR(test1_date, 'DD/MM/YYYY'), manometer1, pressure1, test1_state, obs1, TO_CHAR(test2_date, 'DD/MM/YYYY'), manometer2, pressure2, test2_state, obs2 FROM verification.test_hydro
                        """)
        conn = None
        try:
        # read the connection parameters
