...
"}")
        ...
        self.vLayout3.addItem(spacerItem8)
        ...
        self.vLayout3.addItem(spacerItem9)
        ...
        self.vlLayout4.addItem(spacerItem10)
        ...
        self.vlLayout4.addItem(spacerItem11)
        ...
        self.label_error_newoffer.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.label_error_newoffer.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_error_newoffer.setMinimumSize(QtCore.QSize(200, 25))
        self.label_error_newoffer.setMaximumSize(QtCore.QSize(200, 25))
        self.label_error_newoffer.setStyleSheet("color: rgb(255, 0, 0);")
        self.label_error_newoffer.setText("")
    ...
    def NewOffer(self):
        self.numoffer=self.NumOffer_NewOffer.text()
        self.client=self.Client_NewOffer.text()
        self.finalclient=self.FinalClient_NewOffer.text()
        self.numref=self.NumRef_NewOffer.text()
        self.nacext=self.NacExt_NewOffer.currentText()
        self.buyer=self.Buyer_NewOffer.text()
        self.material=self.Material_NewOffer.currentText()
        self.notes=self.Notes_NewOffer.text()

        if self.numoffer=="" or (self.client=="" or  (self.finalclient=="" or  (self.numref=="" or  self.buyer==""))):
            self.label_error_newoffer.setText('Rellene todos los campos')
        else:
            print(self.numoffer, self.client, self.finalclient, self.numref, self.nacext, self.buyer, self.material, self.notes)
