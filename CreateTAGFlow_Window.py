...
class Ui_CreateTAGFlow_Window(object):
    def setupUi(self, CreateTAGFlow_Window):
        ...
        CreateTAGFlow_Window.resize(705, 605)
        CreateTAGFlow_Window.setMinimumSize(QtCore.QSize(705, 605))
        CreateTAGFlow_Window.setMaximumSize(QtCore.QSize(705, 605))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.label_Tapping.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Tapping.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Platemat.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Platemat.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Platetype.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Platetype.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Platethk.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Platethk.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Platestd.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Platestd.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Gasketmat.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Gasketmat.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Bnmat.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Bnmat.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Nace.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Nace.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Stagesnum.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Stagesnum.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.label_Pipespec.setMinimumSize(QtCore.QSize(120, 25))
        self.label_Pipespec.setMaximumSize(QtCore.QSize(120, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        ...
        CreateTAGFlow_Window.setTabOrder(self.TAG_CreatetagQ, self.NumOffer_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.NumOffer_CreatetagQ, self.Pos_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Pos_CreatetagQ, self.Subpos_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Subpos_CreatetagQ, self.Type_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Type_CreatetagQ, self.Linesize_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Linesize_CreatetagQ, self.Rating_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Rating_CreatetagQ, self.Facing_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Facing_CreatetagQ, self.Sch_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Sch_CreatetagQ, self.Flangemat_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Flangemat_CreatetagQ, self.Tapping_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Tapping_CreatetagQ, self.PlateMat_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.PlateMat_CreatetagQ, self.PlateType_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.PlateType_CreatetagQ, self.PlateThk_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.PlateThk_CreatetagQ, self.GasketMat_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.GasketMat_CreatetagQ, self.BnMat_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.BnMat_CreatetagQ, self.Nace_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.Nace_CreatetagQ, self.StagesNum_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.StagesNum_CreatetagQ, self.PipeSpec_CreatetagQ)
        CreateTAGFlow_Window.setTabOrder(self.PipeSpec_CreatetagQ, self.Button_Create)
        CreateTAGFlow_Window.setTabOrder(self.Button_Create, self.Button_Cancel)
