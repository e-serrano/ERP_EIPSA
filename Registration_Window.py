...
"}")
        ...
        self.frame.setMaximumSize(QtCore.QSize(250, 550))
        ...
        self.email_reg.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.email_reg.sizePolicy().hasHeightForWidth())
        self.email_reg.setSizePolicy(sizePolicy)
