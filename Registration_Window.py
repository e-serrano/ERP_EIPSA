...
class Ui_RegistrationWindow(object):
    def setupUi(self, RegistrationWindow):
        ...
        RegistrationWindow.resize(270, 500)
        RegistrationWindow.setMaximumSize(QtCore.QSize(270, 500))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.frame.setMaximumSize(QtCore.QSize(250, 450))
    ...
    def registration(self):
        ...
        file.close()
        self.reg_root=tk.Tk()
        self.reg_root.iconbitmap('C:/Users/Enrique.serrano/Documents/GIT/ERP_EIPSA/icon.ico')
