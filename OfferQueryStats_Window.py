# Form implementation generated from reading ui file 'QueryOfferStats_Window.ui'
#
...
class Ui_QueryOfferStats_Window(QtWidgets.QMainWindow):
    """
    UI class for the Query offer stats window.
    """
    def __init__(self, year, responsible, state):
        """
        Initializes the Ui_QueryOfferStats_Window.
        
        Attributes:
            year (int): The year for which the offer statistics are queried.
            responsible (str): The individual or department responsible for the offers.
            state (str): The current state of the offers being queried.
        """
        super().__init__()
        self.year = year
    ...
    def setupUi(self, QueryOfferStats_Window):
        """
        Sets up the user interface for the QueryOfferStats_Window.

        Args:
            QueryOfferStats_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        QueryOfferStats_Window.setObjectName("QueryOfferStats_Window")
        QueryOfferStats_Window.resize(845, 590)
        QueryOfferStats_Window.setMinimumSize(QtCore.QSize(1000, 590))
        icon = QtGui.QIcon()
...
"    border-color: rgb(255, 255, 255);\n"
"}")
        self.centralwidget = QtWidgets.QWidget(parent=QueryOfferStats_Window)
        ...
        QueryOfferStats_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=QueryOfferStats_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 845, 22))
        self.menubar.setObjectName("menubar")
        QueryOfferStats_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=QueryOfferStats_Window)
        self.statusbar.setObjectName("statusbar")
        QueryOfferStats_Window.setStatusBar(self.statusbar)
        self.tableQueryOffer.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)

        self.retranslateUi(QueryOfferStats_Window)
        QtCore.QMetaObject.connectSlotsByName(QueryOfferStats_Window)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, QueryOfferStats_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        QueryOfferStats_Window.setWindowTitle(_translate("QueryOfferStats_Window", "Consultar Oferta"))
        item = self.tableQueryOffer.horizontalHeaderItem(0)
        item.setText(_translate("QueryOfferStats_Window", "Nº Oferta"))
        item = self.tableQueryOffer.horizontalHeaderItem(1)
        item.setText(_translate("QueryOfferStats_Window", "Año Oferta"))
        item = self.tableQueryOffer.horizontalHeaderItem(2)
        item.setText(_translate("QueryOfferStats_Window", "Responsable"))
        item = self.tableQueryOffer.horizontalHeaderItem(3)
        item.setText(_translate("QueryOfferStats_Window", "Estado"))
        item = self.tableQueryOffer.horizontalHeaderItem(4)
        item.setText(_translate("QueryOfferStats_Window", "Referencia"))
        ...
        item.setText(_translate("QueryOfferStats_Window", "Material"))
        item = self.tableQueryOffer.horizontalHeaderItem(9)
        item.setText(_translate("QueryOfferStats_Window", "Importe"))
        item = self.tableQueryOffer.horizontalHeaderItem(10)
        item.setText(_translate("QueryOfferStats_Window", "Tipo Tarifa"))
        item = self.tableQueryOffer.horizontalHeaderItem(11)
        item.setText(_translate("QueryOfferStats_Window", "Notas"))
        item = self.tableQueryOffer.horizontalHeaderItem(12)
        item.setText(_translate("QueryOfferStats_Window", "Nº Equipos"))
        item = self.tableQueryOffer.horizontalHeaderItem(13)
        item.setText(_translate("QueryOfferStats_Window", "Fecha Recepción"))
        item = self.tableQueryOffer.horizontalHeaderItem(14)
        item.setText(_translate("QueryOfferStats_Window", "Portal"))
        item = self.tableQueryOffer.horizontalHeaderItem(15)
        item.setText(_translate("QueryOfferStats_Window", "Fecha Límite"))
        item = self.tableQueryOffer.horizontalHeaderItem(16)
        item.setText(_translate("QueryOfferStats_Window", "Fecha Presentación"))
        item = self.tableQueryOffer.horizontalHeaderItem(17)
        item.setText(_translate("QueryOfferStats_Window", "Veces Rec."))
        item = self.tableQueryOffer.horizontalHeaderItem(18)
        item.setText(_translate("QueryOfferStats_Window", "Seguimiento"))
        item = self.tableQueryOffer.horizontalHeaderItem(19)
        item.setText(_translate("QueryOfferStats_Window", "Ptos. Importantes"))
    ...
    def query_offers(self):
        ...
        commands_queryoffer = ("""
                    ...
                    offers."final_client", offers."project", product_type."variable", offers."offer_amount", offers."rate_type", offers."notes", offers."items_number",
                    ...
                    received_offers."final_client", '' as project, product_type."variable", '' as amount, '' as rate_type, received_offers."description", received_offers."items_number",
        ...
        # execution of commands
            ...
            data=(self.year,self.year,self.responsible,self.state,self.year,self.year,self.responsible,self.state,)
...
if __name__ == "__main__":
    ...
    QueryOfferStats_Window = Ui_QueryOfferStats_Window()
    QueryOfferStats_Window.show()
    sys.exit(app.exec())
