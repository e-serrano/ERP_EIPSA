# Form implementation generated from reading ui file 'App_Technical_2.ui'
#
...
class Ui_App_Technical_2(QtWidgets.QMainWindow):
    """
    ...
    def setupUi(self, App_Technical_2):
        """
        Sets up the user interface components for the main application window.

        Args:
            App_Technical_2 (QtWidgets.QMainWindow): The main window object to set up.
        """
        App_Technical_2.setObjectName("App_Technical_2")
        App_Technical_2.resize(945, 860)
        App_Technical_2.setMinimumSize(QtCore.QSize(945, 860))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        App_Technical_2.setWindowIcon(icon)
        App_Technical_2.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QtWidgets.QWidget(parent=App_Technical_2)
...
"}")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/Factory.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.tableDocs.setColumnCount(0)
        ...
        App_Technical_2.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=App_Technical_2)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 945, 22))
        self.menubar.setObjectName("menubar")
        App_Technical_2.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=App_Technical_2)
        self.statusbar.setObjectName("statusbar")
        App_Technical_2.setStatusBar(self.statusbar)
        self.tableDocs.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)

        self.retranslateUi(App_Technical_2)
        self.Button_QueryOrder.clicked.connect(self.query_order)
        ...
        QtCore.QMetaObject.connectSlotsByName(App_Technical_2)

        # self.load_notifications()


# Function to translate and updates the text of various UI elements
    def retranslateUi(self, App_Technical_2):
        """
        Translates and updates the text of various UI elements in the given App_Comercial.
        """
        _translate = QtCore.QCoreApplication.translate
        App_Technical_2.setWindowTitle(_translate("App_Technical_2", "ERP EIPSA - Técnico"))
        self.HeaderName.setText(_translate("App_Technical_2", self.name))
        ...
        # self.Button_QueryTag.setText(_translate("App_Technical_2", "    Consultar TAG(s)"))
        # self.Button_NewDoc.setText(_translate("App_Technical_2", "    Crear Documento"))
        # self.Button_ImportDoc.setText(_translate("App_Technical_2", "    Importar Docum."))
        # self.Button_EditDoc.setText(_translate("App_Technical_2", "    Editar Docum."))
        # self.Button_QueryDoc.setText(_translate("App_Technical_2", "    Consultar Docum."))

    def set_header_buttons(self, username):
        if username in ["julian.martinez"]:
...
if __name__ == "__main__":
    ...
    ui = Ui_App_Technical_2('Julián Martínez','julian.martinez')
