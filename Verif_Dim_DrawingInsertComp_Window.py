# Form implementation generated from reading ui file 'Verif_Dim_DrawingInsertComp_Window.ui'
#
...
class Ui_Verif_Dim_DrawingInsertComp_Window(object):
    def __init__(self, numorder, username):
        self.numorder = numorder
        self.username = username

    def setupUi(self, Verif_Dim_DrawingInsertComp_Window):
        Verif_Dim_DrawingInsertComp_Window.setObjectName("Verif_Dim_DrawingInsertComp_Window")
        Verif_Dim_DrawingInsertComp_Window.resize(450, 325)
        Verif_Dim_DrawingInsertComp_Window.setMinimumSize(QtCore.QSize(450, 325))
        Verif_Dim_DrawingInsertComp_Window.setMaximumSize(QtCore.QSize(450, 325))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Verif_Dim_DrawingInsertComp_Window.setWindowIcon(icon)
        if self.username == 'm.gil':
            Verif_Dim_DrawingInsertComp_Window.setStyleSheet("QWidget {\n"
    ...
    "    border-color: rgb(255, 255, 255);\n"
    "}")
        self.centralwidget = QtWidgets.QWidget(parent=Verif_Dim_DrawingInsertComp_Window)
        ...
        Verif_Dim_DrawingInsertComp_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Verif_Dim_DrawingInsertComp_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 450, 22))
        self.menubar.setObjectName("menubar")
        Verif_Dim_DrawingInsertComp_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Verif_Dim_DrawingInsertComp_Window)
        self.statusbar.setObjectName("statusbar")
        Verif_Dim_DrawingInsertComp_Window.setStatusBar(self.statusbar)
        Verif_Dim_DrawingInsertComp_Window.setWindowFlags(QtCore.Qt.WindowType.WindowMinimizeButtonHint)
        ...
        self.retranslateUi(Verif_Dim_DrawingInsertComp_Window)
        self.Button_Cancel.clicked.connect(Verif_Dim_DrawingInsertComp_Window.close) # type: ignore
        self.Button_Insert.clicked.connect(self.insert_dim_drawing)
        QtCore.QMetaObject.connectSlotsByName(Verif_Dim_DrawingInsertComp_Window)


    def retranslateUi(self, Verif_Dim_DrawingInsertComp_Window):
        _translate = QtCore.QCoreApplication.translate
        Verif_Dim_DrawingInsertComp_Window.setWindowTitle(_translate("Verif_Dim_DrawingInsertComp_Window", "Verificación Planos Dim"))
        self.Button_Insert.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Insertar"))
        self.Button_Cancel.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Cancelar"))
        self.label_num_order.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Nº Pedido:"))
        self.label_obs.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Obs.:"))
        self.label_drawing.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Nº Plano:"))
        self.label_verif_date.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Fecha:"))
        self.label_verif_state.setText(_translate("Verif_Dim_DrawingInsertComp_Window", "Estado:"))


    def insert_dim_drawing(self):
            ...
            if num_order not in  ['ALMACÉN', 'ALMACEN']:
                ...
                if len(results) == 0:
                    ...
                    # execution of commands
                        cur.execute(commands_select_dim_drawing, (num_order, drawing, ))
                        results = cur.fetchall()
...
#     Verif_Dim_DrawingInsertComp_Window = QtWidgets.QMainWindow()
#     ui = Ui_Verif_Dim_DrawingInsertComp_Window('P-23/001')
#     ui.setupUi(Verif_Dim_DrawingInsertComp_Window)
#     Verif_Dim_DrawingInsertComp_Window.show()
#     sys.exit(app.exec())