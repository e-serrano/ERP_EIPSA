# Form implementation generated from reading ui file 'DBEditRegManuff_Window.ui'
#
...
class Ui_DBEditRegManuf_Window(QtWidgets.QMainWindow):
    """
    ...
    def setupUi(self, DBEditRegManuff_Window):
        """
        Sets up the user interface for the DBEditRegManuf_Window.

        Args:
            DBEditRegManuf_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        DBEditRegManuff_Window.setObjectName("DBEditRegManuff_Window")
        DBEditRegManuff_Window.setMinimumSize(QtCore.QSize(1000, 725))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        DBEditRegManuff_Window.setWindowIcon(icon)
        DBEditRegManuff_Window.setStyleSheet("QWidget {\n"
...
"}")
        self.centralwidget = QtWidgets.QWidget(parent=DBEditRegManuff_Window)
...
"}")
        ...
        DBEditRegManuff_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=DBEditRegManuff_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 400, 22))
        self.menubar.setObjectName("menubar")
        DBEditRegManuff_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=DBEditRegManuff_Window)
        self.statusbar.setObjectName("statusbar")
        DBEditRegManuff_Window.setStatusBar(self.statusbar)
        self.tableWidget.setSortingEnabled(False)
        self.tableWidget.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)

        self.retranslateUi(DBEditRegManuff_Window)
        self.comboBox.currentIndexChanged.connect(self.loadtable)
        self.Button_Add.clicked.connect(self.add_dbregister)
        QtCore.QMetaObject.connectSlotsByName(DBEditRegManuff_Window)
        ...
        tables_names=["operations", "personal"]
        # tables_names.sort()
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, DBEditRegManuff_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        DBEditRegManuff_Window.setWindowTitle(_translate("DBEditRegManuff_Window", "Editar Registros Base de Datos"))
        self.labelTable.setText(_translate("DBEditRegManuff_Window", "Tabla:"))
...
# Function to add a new register to table
    def add_dbregister(self):
        ...
        """
        table_name = "fabrication." + self.comboBox.currentText()
...
#     DBEditRegManuff_Window = Ui_DBManufDBEditRegManuff_Window(db)
#     DBEditRegManuff_Window.show()
#     sys.exit(app.exec())