# Form implementation generated from reading ui file 'Verif_ExpInsert_Window.ui'
#
...
class Ui_Verif_ExpInsert_Window(object):
    def __init__(self, numorder):
        self.numorder = numorder

    def setupUi(self, Verif_ExpInsert_Window):
        Verif_ExpInsert_Window.setObjectName("Verif_ExpInsert_Window")
        Verif_ExpInsert_Window.resize(450, 325)
        Verif_ExpInsert_Window.setMinimumSize(QtCore.QSize(450, 325))
        Verif_ExpInsert_Window.setMaximumSize(QtCore.QSize(450, 325))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Verif_ExpInsert_Window.setWindowIcon(icon)
        Verif_ExpInsert_Window.setStyleSheet("QWidget {\n"
...
"    border-color: rgb(255, 255, 255);\n"
"}")
        self.centralwidget = QtWidgets.QWidget(parent=Verif_ExpInsert_Window)
        ...
        self.gridlayout.addWidget(self.notes, 4, 1, 1, 1)
        ...
        Verif_ExpInsert_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Verif_ExpInsert_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 450, 22))
        self.menubar.setObjectName("menubar")
        Verif_ExpInsert_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Verif_ExpInsert_Window)
        self.statusbar.setObjectName("statusbar")
        Verif_ExpInsert_Window.setStatusBar(self.statusbar)
        Verif_ExpInsert_Window.setWindowFlags(QtCore.Qt.WindowType.WindowMinimizeButtonHint)
        ...
        self.retranslateUi(Verif_ExpInsert_Window)
        self.Button_Cancel.clicked.connect(Verif_ExpInsert_Window.close) # type: ignore
        self.Button_Insert.clicked.connect(self.insert_exp)
        QtCore.QMetaObject.connectSlotsByName(Verif_ExpInsert_Window)


    def retranslateUi(self, Verif_ExpInsert_Window):
        _translate = QtCore.QCoreApplication.translate
        Verif_ExpInsert_Window.setWindowTitle(_translate("Verif_ExpInsert_Window", "Verificación EXP"))
        self.Button_Insert.setText(_translate("Verif_ExpInsert_Window", "Insertar"))
        self.Button_Cancel.setText(_translate("Verif_ExpInsert_Window", "Cancelar"))
        self.label_num_order.setText(_translate("Verif_ExpInsert_Window", "Nº Pedido:"))
        self.label_obs.setText(_translate("Verif_ExpInsert_Window", "Obs.:"))
        self.label_verif_date.setText(_translate("Verif_ExpInsert_Window", "Fecha:"))
        ...
        if num_order == "" or verif_date == "":
            ...
            if len(match) == 0:
                ...
                # execution of commands
                    cur.execute(commands_insert_exp, (verif_date, verif_state, notes, num_order, ))
                # close communication with the PostgreSQL database server
                    cur.close()
                # commit the changes
                    conn.commit()
...
if __name__ == "__main__":
    ...
    Verif_ExpInsert_Window = QtWidgets.QMainWindow()
    ui = Ui_Verif_ExpInsert_Window('P-23/001')
    ui.setupUi(Verif_ExpInsert_Window)
    Verif_ExpInsert_Window.show()
    sys.exit(app.exec())