...
# Function to load table and setting in the window
    def query_handtools(self):
        ...
        self.tableHandtools.horizontalHeader().setStyleSheet("::section{font: 800 10pt; background-color: #33bdef; border: 1px solid;}")
...
# Function when item is double clicked
    def item_double_clicked(self,index):
        """
        Opens detailed handtool information if the first column is double-clicked.
        """
        if index.column() == 0:
...
# Function to see revisions of handtool
    def open_handtool_information(self,index):
        ...
        from windows.Workshop_Handtools_Rev_Window import Ui_Workshop_Handtools_Rev_Window
        dbparam = config()
        ...
        self.handtool_rev_window = Ui_Workshop_Handtools_Rev_Window(db_handtool, self.username, value)
        self.handtool_rev_window.showMaximized()
