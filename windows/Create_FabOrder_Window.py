...
class Ui_CreateFabOrder_Window(object):
    ...
    def setupUi(self, ElementsFabOrder_Window):
        ...
        ElementsFabOrder_Window.setStyleSheet(
"QPushButton {\n"
        ...
        for element in self.id_list:
            ...
            if target_row is not None:
                if self.variable == "Caudal":
                    ...
                    ped_type_tag = self.model.data(self.model.index(target_row, 162))
                    codefab_plate = self.model.data(self.model.index(target_row, 184))
                    qty_plate = self.model.data(self.model.index(target_row, 196))
                    data_list.append([tag, ped_type_tag, codefab_plate, qty_plate])

                elif self.variable == "Temperatura":
                    tag = self.model.data(self.model.index(target_row, 1))
                    ped_type_tag = self.model.data(self.model.index(target_row, 143))
                    codefab_sensor = self.model.data(self.model.index(target_row, 162))
                    qty_sensor = self.model.data(self.model.index(target_row, 174))
                    codefab_tw = self.model.data(self.model.index(target_row, 169))
                    qty_tw = self.model.data(self.model.index(target_row, 181))

                    data_list.append([tag, ped_type_tag, codefab_tw, qty_tw, codefab_sensor, qty_sensor])

                elif self.variable == "Nivel":
                    tag = self.model.data(self.model.index(target_row, 1))
                    ped_type_tag = self.model.data(self.model.index(target_row, 124))
                    ...
                    qty_body = self.model.data(self.model.index(target_row, 75))
                    codefab_cover = self.model.data(self.model.index(target_row, 77))
                    qty_cover = self.model.data(self.model.index(target_row, 78))
                    codefab_stud = self.model.data(self.model.index(target_row, 80))
                    qty_stud = self.model.data(self.model.index(target_row, 81))
                    codefab_niphex = self.model.data(self.model.index(target_row, 83))
                    qty_niphex= self.model.data(self.model.index(target_row, 84))
                    codefab_valve = self.model.data(self.model.index(target_row, 86))
                    qty_valve = self.model.data(self.model.index(target_row, 87))
                    codefab_flange = self.model.data(self.model.index(target_row, 89))
                    qty_flange = self.model.data(self.model.index(target_row, 90))
                    codefab_dv = self.model.data(self.model.index(target_row, 92))
                    qty_dv = self.model.data(self.model.index(target_row, 93))
                    codefab_scale = self.model.data(self.model.index(target_row, 95))
                    qty_scale = self.model.data(self.model.index(target_row, 96))
                    codefab_illum = self.model.data(self.model.index(target_row, 98))
                    qty_illum = self.model.data(self.model.index(target_row, 99))
                    codefab_gasketglass = self.model.data(self.model.index(target_row, 101))
                    qty_gasketglass = self.model.data(self.model.index(target_row, 102))
                    codefab_glass = self.model.data(self.model.index(target_row, 104))
                    qty_glass = self.model.data(self.model.index(target_row, 105))
                    codefab_float = self.model.data(self.model.index(target_row, 107))
                    qty_float = self.model.data(self.model.index(target_row, 108))
                    codefab_mica = self.model.data(self.model.index(target_row, 110))
                    qty_mica = self.model.data(self.model.index(target_row, 111))
                    codefab_flags = self.model.data(self.model.index(target_row, 113))
                    qty_flags = self.model.data(self.model.index(target_row, 114))
                    codefab_gasketflange = self.model.data(self.model.index(target_row, 116))
                    qty_gasketflange = self.model.data(self.model.index(target_row, 117))
                    codefab_niptub = self.model.data(self.model.index(target_row, 119))
                    qty_niptub = self.model.data(self.model.index(target_row, 120))
                    codefab_antifrost = self.model.data(self.model.index(target_row, 122))
                    qty_antifrost = self.model.data(self.model.index(target_row, 123))
