...
from windows.ExportDocs_Menu import Ui_ExportDocs_Menu
import pandas as pd
...
# Function to open menu of offer statistics
    def stats_offers(self):
        ...
        """
        from windows.OfferStats_Menu import Ui_StatsOffer_Menu
...
# Function to open window with clients data resume
    def clients_generalresume(self):
        ...
        """
        from windows.ClientsGeneralResume_Window import Ui_ClientsGeneralResume_Window
...
# Function to open window for query tasks
    def querytask(self, date=None):
        ...
        """
        from windows.TaskQuery_Window import Ui_QueryTask_Window
...
# Function to open window for create a new task
    def newtask(self, date):
        ...
        """
        from windows.TaskAdd_Window import Ui_AddTask_Window
...
# Function to load values on table
    def load_table(self):
        ...
        commands_appcomercial_lb = ("""
                    ...
                    "notes","important","tracking","actions"
                    FROM offers
                    WHERE ("responsible" in (%s, 'c.crespo', 'julian.martinez') AND "state" in ('Presentada', 'Registrada', 'En Estudio'))
                    ORDER BY "num_offer"
                    """)
...
# Function when double clicked cell is in client column
    def clientresume(self, item):
        ...
        """
        from windows.ClientResume_Window import Ui_ClientResume_Window
...
# Function to open window with clock-ins
    def clockin(self):
        ...
        """
        from windows.ClockIn_Window import MyCalendarApp
