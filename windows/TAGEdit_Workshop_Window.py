            ...
            if not re.match(r'^(P|PA)-\d{2}/\d{3}.*$', self.numorder):
                ...
                if results_variable == None:
                    ...
                    if self.variable == 'Caudal+Temp':
                        ...
                        self.variable_cells = [101, 104]
                        self.variable_cells2 = [73, 76, 79]
            ...
            if len(id_list) != 0:
                for element in id_list:
                    ...
                    if target_row is not None:
                        ...
                        diameter = "ø = " + self.model.data(self.model.index(target_row, 40)) + " mm"
