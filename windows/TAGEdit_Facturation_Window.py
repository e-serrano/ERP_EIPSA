            ...
            if not re.match(r'^(P|PA)-\d{2}/\d{3}.*$', self.numorder):
                ...
                # Setting the table depenging on the variable
                    if self.variable == 'Caudal+Temp':
                        ...
                        self.initial_column = 144
                        self.initial_column2 = 160
                        self.initial_column_ = 124
                        self.initial_column2_ = 140
                        self.column_position = 150
                        self.column_subposition = 151
                        self.column_difference = 153
                        self.column_position2 = 130
                        self.column_subposition2 = 131
                        self.column_difference2 = 133
                        ...
                        self.initial_column = 144
                        self.initial_column2 = 160
                        self.initial_column_ = 65
                        self.initial_column2_ = 186
                        self.column_position = 150
                        self.column_subposition = 151
                        self.column_difference = 153
                        self.column_position2 = 174
                        self.column_subposition2 = 175
                        self.column_difference2 = 177
                        ...
                        self.initial_column = 124
                        self.initial_column2 = 140
                        self.column_position = 130
                        self.column_subposition = 131
                        self.column_difference = 133
                    elif self.variable == 'Nivel':
                        self.model.setTable("tags_data.tags_level")
                        self.initial_column = 65
                        self.initial_column2 = 186
                        self.column_position = 174
                        self.column_subposition = 175
                        self.column_difference = 177
            ...
            # Hiding unnecesary columns depending on the variable type
                if self.variable == 'Caudal':
                    ...
                    for i in range(70,174):
                        self.tableEditTags.hideColumn(i)
                    self.tableEditTags.hideColumn(183)
                    for i in range(185,columns_number):
                        self.tableEditTags.hideColumn(i)
                ...
                # Hiding unnecesary columns depending on the variable type
                    if self.variable2 == 'Temperatura':
                        ...
                        for i in range(43,66):
                            self.tableEditTags2.hideColumn(i)
                        self.tableEditTags2.hideColumn(67)
                        for i in range(70,174):
                            self.tableEditTags2.hideColumn(i)
                        self.tableEditTags2.hideColumn(183)
                        for i in range(185,columns_number):
                            self.tableEditTags2.hideColumn(i)
                        ...
                        for i in range(25,57):
                            self.tableEditTags2.hideColumn(i)
                        self.tableEditTags2.hideColumn(66)
                        self.tableEditTags2.hideColumn(columns_number-1)
