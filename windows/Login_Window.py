        ...
        try:
            ...
            # checking if password is correct
                    ...
                    if rol_app == 'Comercial':
                        from windows.App_Comercial import Ui_App_Comercial
                        ...
                        from windows.App_Purchasing import Ui_App_Purchasing
                        ...
                        from windows.App_Technical import Ui_App_Technical
                        self.app_window = Ui_App_Technical(results[1] + ' ' + results[2], login_username)
                        self.app_window.showMaximized()
                        self.Login_Window.close()

                    elif rol_app == "Master":
                        from windows.App_Master import Ui_App_Master
                        self.app_window = QtWidgets.QMainWindow()
                        ...
                        from windows.App_Workshop import Ui_App_Workshop
                        self.app_window = QtWidgets.QMainWindow()
                        ...
                        from windows.App_Manager import Ui_App_Manager
                        self.app_window = QtWidgets.QMainWindow()
                        ...
                        from windows.App_SubManager import Ui_App_SubManager
                        self.app_window = QtWidgets.QMainWindow()
                        ...
                        from windows.App_Invoicing import Ui_App_Invoicing
                        self.app_window = QtWidgets.QMainWindow()
                        ...
                        from windows.App_Verification import Ui_App_Verification
                        self.app_window = QtWidgets.QMainWindow()
...
# Function when password has been forgotten
    def forgetpassword(self):
        ...
        """
        from windows.PasswordForget_Window import Ui_ForgetPass_Window
