...
"QMenu::item:selected {background-color: rgb(3, 174, 236);}")
        ...
        self.tableWorkshop_PA.horizontalHeader().setStyleSheet("QHeaderView::section {background-color: #33bdef; border: 1px solid;}")
...
# Function to load orders on tables
    ...
    # Getting the unique values for each column of the model
        ...
        self.tableWorkshop_P.horizontalHeader().setSectionResizeMode(19, QtWidgets.QHeaderView.ResizeMode.Stretch)
        ...
        self.tableWorkshop_PA.horizontalHeader().setSectionResizeMode(19, QtWidgets.QHeaderView.ResizeMode.Stretch)
        self.tableWorkshop_PA.verticalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.ResizeToContents)
