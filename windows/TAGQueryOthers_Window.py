...
class Ui_TAGQueryOthers_Window(QtWidgets.QMainWindow):
    """
    UI class for the Query Tag Others window.
    """
    def __init__(self, role):
        """
        Initializes the Ui_TAGQueryOthers_Window with the specified role.
    ...
    def setupUi(self, TAGQueryOthers_Window):
        """
        Sets up the user interface for the TAGQueryOthers_Window.

        Args:
            TAGQueryOthers_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        ...
        TAGQueryOthers_Window.setStyleSheet(
    "QPushButton {\n"
    "background-color: #33bdef;\n"
    "  border: 1px solid transparent;\n"
    "  border-radius: 3px;\n"
...
# Function to query tags
    def querytags(self):
        """
        Queries the database for all others tags, configures and populates tables with the query results, 
...
# Function to query tags when filters are applied
    def querytags_filtered(self):
        """
        Queries the database for filtered all tags, configures and populates tables with the query results, 
        and updates the UI accordingly. Handles potential database errors and updates the UI with appropriate messages.
        """
        self.tableTags.setRowCount(0)
