...
class Ui_Invoicing_Order_Control_Window(QtWidgets.QMainWindow):
    """
    ...
    def __init__(self, db, username):
        """
        Initializes the Ui_Invoicing_Order_Control_Window, setting up models, proxies, and internal state.
    ...
    def setupUi(self, Invoicing_Order_Control_Window):
        """
        Sets up the user interface components for the main application window.

        Args:
            Invoicing_Order_Control_Window (QtWidgets.QMainWindow): The main window object to set up.
        """
        self.id_list = []
        data_list = []
        Invoicing_Order_Control_Window.setObjectName("Invoicing_Order_Control_Window")
        Invoicing_Order_Control_Window.resize(400, 561)
        Invoicing_Order_Control_Window.setMinimumSize(QtCore.QSize(600, 575))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Invoicing_Order_Control_Window.setWindowIcon(icon)
        Invoicing_Order_Control_Window.setStyleSheet(
"QPushButton {\n"
...
"QMenu::item:selected {background-color: rgb(3, 174, 236);}")
        self.centralwidget = QtWidgets.QWidget(parent=Invoicing_Order_Control_Window)
        ...
        Invoicing_Order_Control_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Invoicing_Order_Control_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 400, 22))
        self.menubar.setObjectName("menubar")
        Invoicing_Order_Control_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Invoicing_Order_Control_Window)
        self.statusbar.setObjectName("statusbar")
        Invoicing_Order_Control_Window.setStatusBar(self.statusbar)
        ...
        self.retranslateUi(Invoicing_Order_Control_Window)
        QtCore.QMetaObject.connectSlotsByName(Invoicing_Order_Control_Window)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, Invoicing_Order_Control_Window):
        """
...
# Function to load orders on tables
    ...
    # Getting the unique values for each column of the model
        ...
        for i in range(42,44):
            self.tableOrders.hideColumn(i)
        for i in range(45,self.model.columnCount()):
            self.tableOrders.hideColumn(i)
...
if __name__ == "__main__":
    ...
    Invoicing_Order_Control_Window = Ui_Invoicing_Order_Control_Window(db_manufacture,'j.sanz')
    Invoicing_Order_Control_Window.show()
    sys.exit(app.exec())