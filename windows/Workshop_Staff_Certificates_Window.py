...
class Ui_Workshop_Staff_Certificates_Window(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Workshop_Staff_Certificates_Window):
        ...
        if self.username in ['m.gil', 'd.marquez']:
            Workshop_Staff_Certificates_Window.setStyleSheet(
...
# Function to load filtered table and setting in the window
    def query_masters(self):
        ...
        if self.username in ['m.gil', 'd.marquez']:
            ...
            self.tableCertificates.horizontalHeader().setStyleSheet("::section{font: 800 10pt; background-color: #33bdef; border: 1px solid black;}")
...
# Function pdf to master
    def add_pdf(self):
        ...
        initialdir="//ERP-EIPSA-DATOS/Comunes/MARIO GIL/VERIFICACION/CERTIFICADOS/" + str(actual_year)
