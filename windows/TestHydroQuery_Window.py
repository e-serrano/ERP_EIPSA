...
class Ui_TestHydroQuery_Window(QtWidgets.QMainWindow):
    """
    UI class for the Query Test Hydro window.
    """
    def __init__(self, username):
        """
        Initializes the Ui_TestHydroQuery_Window with the specified username.
    ...
    def setupUi(self, TestHydroQuery_Window):
        """
        Sets up the user interface for the TestHydroQuery_Window.

        Args:
            TestHydroQuery_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        ...
        TestHydroQuery_Window.setStyleSheet(
"QPushButton {\n"
"background-color: #33bdef;\n"
"  border: 1px solid transparent;\n"
"  border-radius: 3px;\n"
...
#Function when clicking on table header
    ...
    def edit_data(self, item):
        ...
        if num_order in ['ALMACÉN', 'ALMACEN', 'INTERNO', 'PROTOTIPOS']:
            from windows.TestHydroEdit_Window import Ui_TestHydroEdit_Window
