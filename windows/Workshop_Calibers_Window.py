...
# Function to load filtered table and setting in the window
    def query_calibers(self):
        ...
        self.tableCalibers.horizontalHeader().setStyleSheet("::section{font: 800 10pt; background-color: #33bdef; border: 1px solid;}")
...
# Function to see revisions of caliber
    def open_caliber_information(self,index):
        ...
        from windows.Workshop_Calibers_Rev_Window import Ui_Workshop_Calibers_Rev_Window
        dbparam = config()
