        ...
        for element in self.id_list:
            ...
            if target_row is not None:
                ...
                if self.variable == 'Caudal':
                    dim_dwg = self.model.data(self.model.index(target_row, 97))
                    num_of_plate = self.model.data(self.model.index(target_row, 100)) 
                    codefab_eq = self.model.data(self.model.index(target_row, 160))
                    trad_eq = self.model.data(self.model.index(target_row, 161))
                    codefab_orifice_flange = self.model.data(self.model.index(target_row, 174))
                    trad_orifice_flange = self.model.data(self.model.index(target_row, 198))
                    codefab_line_flange = self.model.data(self.model.index(target_row, 175))
                    trad_line_flange = self.model.data(self.model.index(target_row, 199))
                    codefab_gasket = self.model.data(self.model.index(target_row, 176))
                    trad_gasket = self.model.data(self.model.index(target_row, 200))
                    codefab_bolts = self.model.data(self.model.index(target_row, 177))
                    trad_bolts = self.model.data(self.model.index(target_row, 201))
                    codefab_plugs = self.model.data(self.model.index(target_row, 178))
                    trad_plugs = self.model.data(self.model.index(target_row, 202))
                    codefab_extractor = self.model.data(self.model.index(target_row, 179))
                    trad_extractor = self.model.data(self.model.index(target_row, 203))
                    codefab_plate = self.model.data(self.model.index(target_row, 180))
                    trad_plate = self.model.data(self.model.index(target_row, 204))
                    codefab_nipple = self.model.data(self.model.index(target_row, 181))
                    trad_nipple = self.model.data(self.model.index(target_row, 205))
                    codefab_handle = self.model.data(self.model.index(target_row, 182))
                    trad_handle = self.model.data(self.model.index(target_row, 206))
                    codefab_chring = self.model.data(self.model.index(target_row, 183))
                    trad_chring = self.model.data(self.model.index(target_row, 207))
                    codefab_tube = self.model.data(self.model.index(target_row, 184))
                    trad_tube = self.model.data(self.model.index(target_row, 208))
                    codefab_piece2 = self.model.data(self.model.index(target_row, 185))
                    trad_piece2 = self.model.data(self.model.index(target_row, 209))
                    list_dim = [dim_dwg]
                    ...
                    dim_dwg = self.model.data(self.model.index(target_row, 69))
                    num_of_sensor = self.model.data(self.model.index(target_row, 72))
                    num_of = self.model.data(self.model.index(target_row, 75))
                    codefab_eq = self.model.data(self.model.index(target_row, 140))
                    trad_eq = self.model.data(self.model.index(target_row,141))
                    codefab_bar = self.model.data(self.model.index(target_row, 154))
                    trad_bar = self.model.data(self.model.index(target_row, 178))
                    codefab_tube = self.model.data(self.model.index(target_row, 155))
                    trad_tube = self.model.data(self.model.index(target_row, 179))
                    codefab_flange = self.model.data(self.model.index(target_row, 156))
                    trad_flange = self.model.data(self.model.index(target_row, 180))
                    codefab_sensor = self.model.data(self.model.index(target_row, 157))
                    trad_sensor = self.model.data(self.model.index(target_row, 181))
                    codefab_head = self.model.data(self.model.index(target_row, 158))
                    trad_head = self.model.data(self.model.index(target_row, 182))
                    codefab_btb = self.model.data(self.model.index(target_row, 159))
                    trad_btb = self.model.data(self.model.index(target_row, 183))
                    codefab_nipple = self.model.data(self.model.index(target_row, 160))
                    trad_nipple = self.model.data(self.model.index(target_row, 184))
                    codefab_spring = self.model.data(self.model.index(target_row, 161))
                    trad_spring = self.model.data(self.model.index(target_row, 185))
                    codefab_puntal = self.model.data(self.model.index(target_row, 162))
                    trad_puntal = self.model.data(self.model.index(target_row, 186))
                    codefab_plug = self.model.data(self.model.index(target_row, 163))
                    trad_plug = self.model.data(self.model.index(target_row, 187))
                    codefab_tw = self.model.data(self.model.index(target_row, 164))
                    trad_tw = self.model.data(self.model.index(target_row, 188))
                    codefab_cable = self.model.data(self.model.index(target_row, 165))
                    trad_cable = self.model.data(self.model.index(target_row, 189))
                    list_dim = [dim_dwg]
