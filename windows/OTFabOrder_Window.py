        ...
        for element in self.id_list:
            ...
            if target_row is not None:
                ...
                if self.variable == 'Caudal':
                    ...
                    codefab_eq = self.model.data(self.model.index(target_row, 141))
                    trad_eq = self.model.data(self.model.index(target_row,142))
                    codefab_bar = self.model.data(self.model.index(target_row, 155))
                    trad_bar = self.model.data(self.model.index(target_row, 179))
                    codefab_tube = self.model.data(self.model.index(target_row, 156))
                    trad_tube = self.model.data(self.model.index(target_row, 180))
                    codefab_flange = self.model.data(self.model.index(target_row, 157))
                    trad_flange = self.model.data(self.model.index(target_row, 181))
                    codefab_sensor = self.model.data(self.model.index(target_row, 158))
                    trad_sensor = self.model.data(self.model.index(target_row, 182))
                    codefab_head = self.model.data(self.model.index(target_row, 156))
                    trad_head = self.model.data(self.model.index(target_row, 183))
                    codefab_btb = self.model.data(self.model.index(target_row, 160))
                    trad_btb = self.model.data(self.model.index(target_row, 184))
                    codefab_nipple = self.model.data(self.model.index(target_row, 161))
                    trad_nipple = self.model.data(self.model.index(target_row, 185))
                    codefab_spring = self.model.data(self.model.index(target_row, 162))
                    trad_spring = self.model.data(self.model.index(target_row, 186))
                    codefab_puntal = self.model.data(self.model.index(target_row, 163))
                    trad_puntal = self.model.data(self.model.index(target_row, 187))
                    codefab_plug = self.model.data(self.model.index(target_row, 164))
                    trad_plug = self.model.data(self.model.index(target_row, 188))
                    codefab_tw = self.model.data(self.model.index(target_row, 165))
                    trad_tw = self.model.data(self.model.index(target_row, 189))
                    codefab_cable = self.model.data(self.model.index(target_row, 166))
                    trad_cable = self.model.data(self.model.index(target_row, 190))
                    list_dim = [dim_dwg]
