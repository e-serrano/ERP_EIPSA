        ...
        for element in self.id_list:
            ...
            if target_row is not None:
                ...
                if self.variable == 'Caudal':
                    ...
                    codefab_orifice_flange = self.model.data(self.model.index(target_row, 178))
                    trad_orifice_flange = self.model.data(self.model.index(target_row, 202))
                    codefab_line_flange = self.model.data(self.model.index(target_row, 179))
                    trad_line_flange = self.model.data(self.model.index(target_row, 203))
                    codefab_gasket = self.model.data(self.model.index(target_row, 180))
                    trad_gasket = self.model.data(self.model.index(target_row, 204))
                    codefab_bolts = self.model.data(self.model.index(target_row, 181))
                    trad_bolts = self.model.data(self.model.index(target_row, 205))
                    codefab_plugs = self.model.data(self.model.index(target_row, 182))
                    trad_plugs = self.model.data(self.model.index(target_row, 206))
                    codefab_extractor = self.model.data(self.model.index(target_row, 183))
                    trad_extractor = self.model.data(self.model.index(target_row, 207))
                    codefab_plate = self.model.data(self.model.index(target_row, 184))
                    trad_plate = self.model.data(self.model.index(target_row, 208))
                    codefab_nipple = self.model.data(self.model.index(target_row, 185))
                    trad_nipple = self.model.data(self.model.index(target_row, 209))
                    codefab_handle = self.model.data(self.model.index(target_row, 186))
                    trad_handle = self.model.data(self.model.index(target_row, 210))
                    codefab_chring = self.model.data(self.model.index(target_row, 187))
                    trad_chring = self.model.data(self.model.index(target_row, 211))
                    codefab_tube = self.model.data(self.model.index(target_row, 188))
                    ...
                    trad_eq = self.model.data(self.model.index(target_row,146))
                    codefab_bar = self.model.data(self.model.index(target_row, 159))
                    trad_bar = self.model.data(self.model.index(target_row, 183))
                    codefab_tube = self.model.data(self.model.index(target_row, 160))
                    trad_tube = self.model.data(self.model.index(target_row, 184))
                    codefab_flange = self.model.data(self.model.index(target_row, 161))
                    trad_flange = self.model.data(self.model.index(target_row, 185))
                    codefab_sensor = self.model.data(self.model.index(target_row, 162))
                    trad_sensor = self.model.data(self.model.index(target_row, 186))
                    codefab_head = self.model.data(self.model.index(target_row, 163))
                    trad_head = self.model.data(self.model.index(target_row, 187))
                    codefab_btb = self.model.data(self.model.index(target_row, 164))
                    trad_btb = self.model.data(self.model.index(target_row, 188))
                    codefab_nipple = self.model.data(self.model.index(target_row, 165))
                    trad_nipple = self.model.data(self.model.index(target_row, 189))
                    codefab_spring = self.model.data(self.model.index(target_row, 166))
                    trad_spring = self.model.data(self.model.index(target_row, 190))
                    codefab_puntal = self.model.data(self.model.index(target_row, 167))
                    trad_puntal = self.model.data(self.model.index(target_row, 191))
                    codefab_plug = self.model.data(self.model.index(target_row, 168))
                    trad_plug = self.model.data(self.model.index(target_row, 192))
                    codefab_tw = self.model.data(self.model.index(target_row, 169))
                    ...
                    dim_dwg = self.model.data(self.model.index(target_row, 55))
                    num_of = self.model.data(self.model.index(target_row, 56))
                    codefab_eq = self.model.data(self.model.index(target_row, 71))
                    trad_eq = self.model.data(self.model.index(target_row, 72))
                    codefab_body = self.model.data(self.model.index(target_row, 74))
                    trad_body = self.model.data(self.model.index(target_row, 125))
                    codefab_cover = self.model.data(self.model.index(target_row, 77))
                    trad_cover = self.model.data(self.model.index(target_row, 126))
                    codefab_stud = self.model.data(self.model.index(target_row, 80))
                    trad_stud = self.model.data(self.model.index(target_row, 127))
                    codefab_niphex = self.model.data(self.model.index(target_row, 83))
                    trad_niphex= self.model.data(self.model.index(target_row, 128))
                    codefab_valve = self.model.data(self.model.index(target_row, 86))
                    trad_valve = self.model.data(self.model.index(target_row, 129))
                    codefab_flange = self.model.data(self.model.index(target_row, 89))
                    trad_flange = self.model.data(self.model.index(target_row, 130))
                    codefab_dv = self.model.data(self.model.index(target_row, 92))
                    trad_dv = self.model.data(self.model.index(target_row, 131))
                    codefab_scale = self.model.data(self.model.index(target_row, 95))
                    trad_scale = self.model.data(self.model.index(target_row, 132))
                    codefab_illum = self.model.data(self.model.index(target_row, 98))
                    trad_illum = self.model.data(self.model.index(target_row, 133))
                    codefab_gasketglass = self.model.data(self.model.index(target_row, 101))
                    trad_gasketglass = self.model.data(self.model.index(target_row, 134))
                    codefab_glass = self.model.data(self.model.index(target_row, 104))
                    trad_glass = self.model.data(self.model.index(target_row, 135))
                    codefab_float = self.model.data(self.model.index(target_row, 107))
                    trad_float = self.model.data(self.model.index(target_row, 136))
                    codefab_mica = self.model.data(self.model.index(target_row, 110))
                    trad_mica = self.model.data(self.model.index(target_row, 137))
                    codefab_flags = self.model.data(self.model.index(target_row, 112))
                    trad_flags = self.model.data(self.model.index(target_row, 138))
                    codefab_gasketflange = self.model.data(self.model.index(target_row, 116))
                    trad_gasketflange = self.model.data(self.model.index(target_row, 139))
                    codefab_niptub = self.model.data(self.model.index(target_row, 119))
