...
from windows.overlay_pdf import new_content_notes, new_content_tags
...
"}")
        ...
        if self.username in ['julian.martinez']:
            ...
            if self.username in ['j.martinez']:
                self.Button_QueryOffer = QtWidgets.QPushButton(parent=self.ButtonFrame)
                self.Button_QueryOffer.setMinimumSize(QtCore.QSize(200, 50))
                self.Button_QueryOffer.setMaximumSize(QtCore.QSize(200, 50))
                font = QtGui.QFont()
...
# Function to open window with OT table
    def otorder(self):
        ...
        """
        from windows.OTGeneralCreate_Window import Ui_OTGeneralCreate_Window
...
# Function to open window to insert test data
    def insert_test(self):
        ...
        """
        from windows.Tests_Menu import Ui_Tests_Menu
...
# Function to open window with all notifications table
    def notifications_all(self):
        ...
        Opens a new window to show active notifications. 
        """
        from windows.NotificationsAll_History_Window import Ui_HistoryNotificationsAll_Window
...
# Function to open window for order query
    def query_order(self):
        ...
        """
        from windows.OrderQuery_Window import Ui_QueryOrder_Window
...
# Function to open window for documentation creation
    def create_documents(self):
        ...
        """
        from windows.DocNew_Window import Ui_New_Doc_Window
...
# Function to open window for documentation query
    def query_documents(self):
        ...
        """
        from windows.DocQuery_Window import Ui_QueryDoc_Window
...
# Function to show clock-in menu
    def clockin(self):
        ...
        """
        from windows.ClockIn_Menu import Ui_ClockIn_Menu
...
# Function to show clock-in menu
    def factory(self):
        ...
        """
        from windows.Factory_Menu import Ui_Factory_Menu
...
# Function to open menu for document control
    def portal_doc(self):
        ...
        """
        from windows.DocPortal_Menu import Ui_PortalDoc_Menu
...
# Funtion to show window with manufacturing times
    def checktimes(self):
        ...
        """
        from windows.TimesQuery_Window import Ui_TimesQuery_Window
                                                    ...
                                                    if ana_order != '':
                                                        while True:
                                                            ...
                                                            if clickedButton4 == 1:
                                                                ...
                                                                if line_number != '':
                                                                    from windows.Excel_Export_Templates import nuclear_annexes
...
# Function to open menu with purchase department functions
    def purchase(self):
        ...
        """
        from windows.Purchasing_Menu import Ui_Purchasing_Menu
                    ...
                    if query_type[0] == 'P':
                        while True:
                            ...
                            if clickedButton == 1:
                                numorder = dlg.textValue()
                                if numorder != '':
                                    from windows.FabTimes_Window import Ui_FabTimes_Window
...
# Function to open window for edit offers
    def edit_offer(self):
        ...
        """
        from windows.OfferEdit_Menu import Ui_EditOffer_Menu
...
# Function to open reclamation window
    def reclamation_offer(self):
        ...
        """
        from windows.OfferReclamation_Window import Ui_ReclamationOffer_Window
...
# Function to open window for create orders
    def new_order(self):
        ...
        """
        from windows.OrderNewAddData_Window import Ui_New_OrderAddData_Window
...
# Function to open window for edit orders
    def edit_order(self):
        ...
        """
        from windows.OrderEdit_Menu import Ui_EditOrder_Menu
...
# Function to open window for create tags
    def new_tag(self):
        ...
        """
        from windows.TAGCreate_Menu import Ui_CreateTag_Menu
...
# Function when double clicked cell is in client column
    def editofferform(self, item):
        ...
        """
        from windows.OfferEdit_Window import Ui_Edit_Offer_Window
        num_offer=item.text()
...
# Function to open window for query offers
    def query_offer(self):
        ...
        """
        from windows.OfferQuery_Window import Ui_QueryOffer_Window
...
# Function to open window for importing tags
    def import_tag(self):
        ...
        """
        from windows.TAGImport_Window import Ui_ImportTAG_Window
