...
import fnmatch
import random
from windows.Verif_Order_Window import Ui_Verif_Order_Window
from utils.Database_Manager import Database_Connection
from utils.Show_Message import MessageHelper
from config.config_keys import DATA_PATH, ORDERS_PATH
...
class Ui_VerificationInsert_Window(QtWidgets.QMainWindow):
    ...
    "\n")
        ...
        self.hn_lp_penetrating = QtWidgets.QLineEdit(parent=self.frame)
        self.hn_lp_penetrating.setMinimumSize(QtCore.QSize(170, 25))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.hn_lp_penetrating.setFont(font)
        self.hn_lp_penetrating.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.hn_lp_penetrating.setObjectName("hn_lp_penetrating")
        self.gridLayout_2.addWidget(self.hn_lp_penetrating, 4, 1, 1, 1)
        self.hn_lp_revealing = QtWidgets.QLineEdit(parent=self.frame)
        self.hn_lp_revealing.setMinimumSize(QtCore.QSize(170, 25))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.hn_lp_revealing.setFont(font)
        self.hn_lp_revealing.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.hn_lp_revealing.setObjectName("hn_lp_revealing")
        self.gridLayout_2.addWidget(self.hn_lp_revealing, 4, 2, 1, 1)
        self.hn_lp_remover = QtWidgets.QLineEdit(parent=self.frame)
        self.hn_lp_remover.setMinimumSize(QtCore.QSize(170, 25))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.hn_lp_remover.setFont(font)
        self.hn_lp_remover.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.hn_lp_remover.setObjectName("hn_lp_remover")
        self.gridLayout_2.addWidget(self.hn_lp_remover, 4, 3, 1, 1)
        self.label_lp_penetrating = QtWidgets.QLabel(parent=self.frame)
        self.label_lp_penetrating.setMinimumSize(QtCore.QSize(204, 25))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        self.label_lp_penetrating.setFont(font)
        self.label_lp_penetrating.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_lp_penetrating.setObjectName("label_lp_penetrating")
        self.gridLayout_2.addWidget(self.label_lp_penetrating, 5, 1, 1, 1)
        self.label_lp_revealing = QtWidgets.QLabel(parent=self.frame)
        self.label_lp_revealing.setMinimumSize(QtCore.QSize(204, 25))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        self.label_lp_revealing.setFont(font)
        self.label_lp_revealing.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_lp_revealing.setObjectName("label_lp_revealing")
        self.gridLayout_2.addWidget(self.label_lp_revealing, 5, 2, 1, 1)
        self.label_lp_remover = QtWidgets.QLabel(parent=self.frame)
        self.label_lp_remover.setMinimumSize(QtCore.QSize(204, 25))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        self.label_lp_remover.setFont(font)
        self.label_lp_remover.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_lp_remover.setObjectName("label_lp_remover")
        self.gridLayout_2.addWidget(self.label_lp_remover, 5, 3, 1, 1)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, VerificationInsert_Window):
        ...
        self.label_lp_penetrating.setText(_translate("VerificationInsert_Window", "Penetrante"))
        self.label_lp_revealing.setText(_translate("VerificationInsert_Window", "Revelador"))
        self.label_lp_remover.setText(_translate("VerificationInsert_Window", "Eliminador"))
                    ...
                    # execution of commands
                        for index in selected_indexes:
                            ...
                            if self.label_lptest.checkState() == QtCore.Qt.CheckState.Checked:
                                ...
                                # match_liq1 = list(filter(lambda x: x[0] == 'remover', results_hn))
...
# Function to set fixed values
    def load_values(self):
        ...
        query_lp = ("""
                    ...
                    WHERE product LIKE 'LP_%' and quantity > 0
        ...
        self.hn_lp_penetrating.setText(list_lp[0])
        self.hn_lp_revealing.setText(list_lp[1])
        self.hn_lp_remover.setText(list_lp[2])
