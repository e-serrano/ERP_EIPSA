...
from utils.Item_Prices import set_prices_flow, set_prices_temp, set_prices_level
    ...
    def configure_models(self, variable):
        ...
        try:
            ...
            if self.general_variable in ("Caudal+Temperatura", "Caudal+Nivel", "Temperatura+Nivel"):
                ...
                self.tableEditTags2.setModel(None)
                self.proxy2.setSourceModel(None)

                self.model2.setTable(table2)
                self.model2.select()

                self.proxy2.setSourceModel(self.model2)
                self.tableEditTags2.setModel(self.proxy2)

                self.model.setAllColumnHeaders(headers1)
        ...
        try:
            ...
            if self.variable != '':
                ...
                if self.variable == 'Caudal':
                    ...
                    self.tableEditTags.showColumn(111) # PMI test date
                    self.tableEditTags.showColumn(112) # Hydrostatic test 1 date
                    self.tableEditTags.showColumn(117) # Hydrostatic test 2 date
                    self.tableEditTags.showColumn(122) # Liquids test date
                    self.tableEditTags.showColumn(128) # Hardness test date
                    self.tableEditTags.showColumn(136) # Dim drawing verification date
                    self.tableEditTags.showColumn(139) # OF drawing verification date

                    self.tableEditTags.showColumn(152) # Amount difference column
                    self.tableEditTags.showColumn(158) # Invoice number column
                    ...
                    for i in range(82,120):
                        self.tableEditTags.hideColumn(i)
                    for i in range(130, columns_number):
                        self.tableEditTags.hideColumn(i)

                    self.tableEditTags.showColumn(86) # PMI test date
                    self.tableEditTags.showColumn(87) # Hydrostatic test 1 date
                    self.tableEditTags.showColumn(92) # Hydrostatic test 2 date
                    self.tableEditTags.showColumn(97) # Liquids test date
                    self.tableEditTags.showColumn(103) # Hardness test date
                    self.tableEditTags.showColumn(111) # Dim drawing verification date
                    self.tableEditTags.showColumn(114) # OF drawing verification date
                    self.tableEditTags.showColumn(117) # OF sensor drawing verification date

                    self.tableEditTags.showColumn(132) # Amount difference column
                    self.tableEditTags.showColumn(138) # Invoice number column
            ...
            # Getting the unique values for each column of the model
                ...
                if self.variable2 is not None:
                    ...
                    if self.variable2 == 'Temperatura':
                        ...
                        self.tableEditTags2.showColumn(133) # Amount difference column
                        self.tableEditTags2.showColumn(138) # Invoice number column
                        self.tableEditTags2.showColumn(140) # Dim drawing path column
                        self.tableEditTags2.showColumn(141) # OF drawing path column
                        self.tableEditTags2.showColumn(142) # OF sensor drawing path column
                        ...
                        for i in range(174,176):
                            self.tableEditTags2.hideColumn(i)
                        for i in range(178,columns_number-1):
                            self.tableEditTags2.hideColumn(i)
                ...
                # Getting the unique values for each column of the model
                    ...
                    self.selection_model2 = self.tableEditTags2.selectionModel()
                    self.selection_model2.selectionChanged.connect(lambda: self.countSelectedCells(self.model2))
...
# Function to open equipment photos
    def open_pics(self, index, variable):
        ...
        """
        if ((variable == 'Caudal' and index.column() in [142, 143])
        or (variable == 'Temperatura' and index.column() in [120, 121])
        or (variable == 'Nivel' and index.column() in [173, 183])
                ...
                while True:
                    if framework == 'Informe Equipos (GL)':
                        ...
                        if self.proxy.rowCount() == 0:
                            ...
                            if self.variable2 is not None:
                                material_list(self.proxy2, self.model2, self.variable2, self.numoffer)
                        break
