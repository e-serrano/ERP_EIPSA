        ...
        try:
            if id_invoice == '':
                ...
                if result == QtWidgets.QMessageBox.StandardButton.Yes:
                    from windows.PDF_Styles import client_invoice
                    while True:
...
# Function to search invoice
    def search_invoice(self, Invoice_Window):
        ...
        """
        from windows.InvoiceSearch_Window import Ui_InvoiceSearch_Window
...
# Function to generate delivery note
    def generate_delivnote(self):
        ...
        if invoice_id == '':
            ...
            from windows.PDF_Styles import delivery_note
            while True:
                answer, ok = QtWidgets.QInputDialog.getItem(self, "Albarán", "¿Con logo?:", ['Sí', 'No'], 0, False)
                if ok and answer:
                    if answer == 'Sí':
...
# Function to import data into and existing table from and Excel where first row is column name
    def import_tags(self):
        ...
        if id_invoice == "":
            dlg = QtWidgets.QMessageBox()
            new_icon = QtGui.QIcon()
            new_icon.addPixmap(QtGui.QPixmap("//ERP-EIPSA-DATOS/Comunes/EIPSA-ERP/Iconos/icon.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
            dlg.setWindowIcon(new_icon)
            dlg.setWindowTitle("ERP EIPSA")
            ...
            #Importing excel file into dataframe
                ...
                first_empty_index = df_table[(df_table['item'] == '') | df_table['item'].isna()].index.min()

                df_final = df_table.iloc[:first_empty_index,:6]
