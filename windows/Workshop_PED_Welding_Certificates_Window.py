...
from windows.PDF_Styles import welding_homologation
...
class Ui_Workshop_PED_Welding_Certificates_Window(QtWidgets.QMainWindow):
    """
    ...
    def setupUi(self, Workshop_PED_Welding_Certificates_Window):
        """
        Sets up the user interface for the Workshop_PED_Welding_Certificates_Window.

        Args:
            Workshop_PED_Welding_Certificates_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        Workshop_PED_Welding_Certificates_Window.setObjectName("Workshop_PED_Welding_Certificates_Window")
        Workshop_PED_Welding_Certificates_Window.resize(790, 595)
        Workshop_PED_Welding_Certificates_Window.setMinimumSize(QtCore.QSize(790, 595))
        icon = QtGui.QIcon()
        ...
        Workshop_PED_Welding_Certificates_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Workshop_PED_Welding_Certificates_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 790, 22))
        self.menubar.setObjectName("menubar")
        Workshop_PED_Welding_Certificates_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Workshop_PED_Welding_Certificates_Window)
        self.statusbar.setObjectName("statusbar")
        Workshop_PED_Welding_Certificates_Window.setStatusBar(self.statusbar)

        self.retranslateUi(Workshop_PED_Welding_Certificates_Window)
        QtCore.QMetaObject.connectSlotsByName(Workshop_PED_Welding_Certificates_Window)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, Workshop_PED_Welding_Certificates_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        Workshop_PED_Welding_Certificates_Window.setWindowTitle(_translate("Workshop_PED_Welding_Certificates_Window", "Certificados Soldadura PED"))
...
# Function to load filtered table and setting in the window
    def query_certificates(self):
        """
        Queries the database for PED_Welding certificates with filter applied, configures and populates tables with the query results, 
        ...
        self.model.setTable("verification.PED_Welding_certificates")
    ...
    # Change all column names
        headers_names = ["ID", "PROCEDIMIENTO", "OT-WPS", "OT-PQR", "P+P", "PROCESO", "MATERIALES", "DIÁMETROS",
                        "ESP. HOMOL.", "ESP. PROCESO", "ENSAYOS", "SOLDADORES", "FECHA CERT.", "FECHA EXP.", "FECHA SOLD.", "CERTIFICADO"]
...
# Function to add a new line
    def add_new(self):
        """
        Inserts a new empty entry into the PED_Welding certificates table.
        Commits the changes to the database and handles any errors.
        """
        commands_new=("""
                        INSERT INTO verification.PED_Welding_certificates (procedure)
                        VALUES(%s)
                        """)
        conn = None
        try:
...
# Function to adjust table size
    def adjust_table(self):
        ...
        self.tableCertificates.horizontalHeader().setSectionResizeMode(10,QtWidgets.QHeaderView.ResizeMode.Interactive)
        self.tableCertificates.horizontalHeader().setSectionResizeMode(15,QtWidgets.QHeaderView.ResizeMode.Interactive)
        self.tableCertificates.verticalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.ResizeToContents)
        self.tableCertificates.setColumnWidth(10, 300)
        self.tableCertificates.setColumnWidth(15, 500)
        self.tableCertificates.verticalHeader().setVisible(False)
    ...
    def add_pdf(self):
        ...
        if len(selected_indexes) == 1:
            ...
            if index.column() in [15]:
                ...
                if pdf_path:
                    commands_insert_1 = ("""
                            UPDATE verification."PED_Welding_certificates"
                            SET "certificate" = %s
                            WHERE "id" = %s
                            """)
...
if __name__ == "__main__":
    ...
    Workshop_PED_Welding_Certificates_Window = Ui_Workshop_PED_Welding_Certificates_Window(db, 'm.gil')
    Workshop_PED_Welding_Certificates_Window.showMaximized()
    sys.exit(app.exec())