...
# Function to query data related to welding operation
    def welding_data(self):
        ...
        """
        from windows.Welding_Menu import Ui_Welding_Menu
...
# Function to open warehouse window
    def warehouse_app(self):
        ...
        """
        from windows.App_Warehouse import Ui_App_Warehouse
...
# Function to open active offers window
    def open_active_offers(self):
        ...
        """
        from windows.OfferQueryActive_Window import Ui_OfferQueryActive_Window
                    ...
                    if date_1 != '':
                        while True:
                            ...
                            if clickedButton2 == 1:
                                ...
                                existing_workbook = r"\\ERP-EIPSA-DATOS\Comunes\ENRIQUE SERRANO\05 COSAS DANI\OFERTAS\MASTER OFERTAS.xlsm"
