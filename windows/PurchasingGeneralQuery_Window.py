...
class Ui_PurchasingGeneralQuery_Window(QtWidgets.QMainWindow):
    """
    UI class for the General Query for suppliers orders window.
    """
    def __init__(self):
        """
        Initializes the Ui_PurchasingGeneralQuery_Window.
        """
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, PurchasingGeneralQuery_Window):
        """
        Sets up the user interface for the PurchasingGeneralQuery_Window.

        Args:
            PurchasingGeneralQuery_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
...
# Function to translate and updates the text of various UI elements
    ...
    def on_item_double_clicked(self, item):
        ...
        Opens the 'PurchasingDetailQuery' window. Sets up the UI for the user.
        
        Args:
            item (QtWidgets.QTableWidgetItem): The item that was double-clicked.
        """
        from windows.PurchasingDetailQuery_Window import Ui_PurchasingDetailQuery_Window
