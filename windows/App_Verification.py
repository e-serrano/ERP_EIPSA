...
class Ui_App_Verification(object):
    ...
    "}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Timer.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    "}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Hydro.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    "}")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Flanges.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    "}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Mario.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    "}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Verification.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Verification_Order.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Drawing_Index.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Calibration.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(str(get_path("Resources", "Iconos", "Supplier.png"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        font_id = QtGui.QFontDatabase.addApplicationFont(str(get_path("Resources", "Iconos", "DS-DIGI.ttf")))
        if font_id != -1:
...
# Function to open corresponding window when Verification button is clicked
    def verification(self):
        ...
        """
        from windows.VerificationInsert_Window import Ui_VerificationInsert_Window
...
# Function to open corresponding window when Test button is clicked
    def tests(self):
        """Open the Test menu."""
        from windows.Verif_Tests_Menu import Ui_Verif_Tests_Menu
...
# Function to open corresponding window when Suppliers button is clicked
    def suppliers_delivnote(self):
        ...
        """
        from windows.VerifSupplierInsert_Window import Ui_VerifSupplierInsert_Window
...
# Function to open window with timer
    def timer(self):
        ...
        """
        from windows.TimerWindow import Ui_TimerWindow
...
# Function to open menu with different types of revisions
    def revisions(self):
        ...
        """
        from windows.Verif_Revisions_Menu import Ui_Verif_Revisions_Menu
...
# Function to open window with for insert additional pieces manufactured
    def aditional_pieces(self):
        ...
        """
        from windows.VerifPiecesInsert_Window import Ui_VerifPiecesInsert_Window
...
# Function to open menu with different types of revisions
    def flanges_information(self):
        ...
        """
        from windows.Verif_Flange_Information import Ui_Verif_Flange_Information_Window
...
# Function to open window to check notifications
    def notifications(self):
        ...
        """
        from windows.NotificationsHistory_Window import Ui_HistoryNotifications_Window
