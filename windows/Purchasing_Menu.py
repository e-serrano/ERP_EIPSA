...
from windows.SupplierOrder_Window import Ui_SupplierOrder_Window
from windows.ClientOrder_Window import Ui_ClientOrder_Window
from windows.Quotation_Window import Ui_Quotation_Window
from windows.Supplies_Window import Ui_Supplies_Window
...
class Ui_Purchasing_Menu(object):
    ...
    "QPushButton {\n"
        ...
        self.centralwidget.setMinimumSize(QtCore.QSize(int(615//self.scale), int(360//self.scale)))
        self.centralwidget.setMaximumSize(QtCore.QSize(int(615//self.scale), int(360//self.scale)))
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout.setObjectName("gridLayout")
        self.frame = QtWidgets.QFrame(parent=self.centralwidget)
        self.frame.setMinimumSize(QtCore.QSize(int(275//self.scale), int(325//self.scale)))
        ...
        self.Button_Supplies.setMinimumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        self.Button_Supplies.setMaximumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        ...
        self.Button_ClientOrder.setMinimumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        self.Button_ClientOrder.setMaximumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        ...
        self.Button_SupplierOrder.setMinimumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        self.Button_SupplierOrder.setMaximumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        ...
        self.Button_Quotation.setMinimumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        self.Button_Quotation.setMaximumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        ...
        self.Button_Databases.setMinimumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        self.Button_Databases.setMaximumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        ...
        self.Button_Reports.setMinimumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
        self.Button_Reports.setMaximumSize(QtCore.QSize(int(250//self.scale), int(35//self.scale)))
