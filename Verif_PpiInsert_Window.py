# Form implementation generated from reading ui file 'Verif_PpiInsert_Window.ui'
#
...
class Ui_Verif_PpiInsert_Window(object):
    def __init__(self, numorder):
        self.numorder = numorder

    def setupUi(self, Verif_PpiInsert_Window):
        Verif_PpiInsert_Window.setObjectName("Verif_PpiInsert_Window")
        Verif_PpiInsert_Window.resize(450, 325)
        Verif_PpiInsert_Window.setMinimumSize(QtCore.QSize(450, 325))
        Verif_PpiInsert_Window.setMaximumSize(QtCore.QSize(450, 325))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Verif_PpiInsert_Window.setWindowIcon(icon)
        Verif_PpiInsert_Window.setStyleSheet("QWidget {\n"
...
"    border-color: rgb(255, 255, 255);\n"
"}")
        self.centralwidget = QtWidgets.QWidget(parent=Verif_PpiInsert_Window)
        ...
        Verif_PpiInsert_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Verif_PpiInsert_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 450, 22))
        self.menubar.setObjectName("menubar")
        Verif_PpiInsert_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Verif_PpiInsert_Window)
        self.statusbar.setObjectName("statusbar")
        Verif_PpiInsert_Window.setStatusBar(self.statusbar)
        Verif_PpiInsert_Window.setWindowFlags(QtCore.Qt.WindowType.WindowMinimizeButtonHint)
        ...
        self.retranslateUi(Verif_PpiInsert_Window)
        self.Button_Cancel.clicked.connect(Verif_PpiInsert_Window.close) # type: ignore
        self.Button_Insert.clicked.connect(self.insert_ppi)
        QtCore.QMetaObject.connectSlotsByName(Verif_PpiInsert_Window)


    def retranslateUi(self, Verif_PpiInsert_Window):
        _translate = QtCore.QCoreApplication.translate
        Verif_PpiInsert_Window.setWindowTitle(_translate("Verif_PpiInsert_Window", "Verificación PPI"))
        self.Button_Insert.setText(_translate("Verif_PpiInsert_Window", "Insertar"))
        self.Button_Cancel.setText(_translate("Verif_PpiInsert_Window", "Cancelar"))
        self.label_num_order.setText(_translate("Verif_PpiInsert_Window", "Nº Pedido:"))
        self.label_obs.setText(_translate("Verif_PpiInsert_Window", "Obs.:"))
        self.label_verif_date.setText(_translate("Verif_PpiInsert_Window", "Fecha:"))
        ...
        if num_order == "" or verif_date == "":
            ...
            if len(match) == 0:
                ...
                # execution of commands
                    cur.execute(commands_insert_ppi, (verif_date, verif_state, notes, num_order, ))
                # close communication with the PostgreSQL database server
                    cur.close()
                # commit the changes
                    conn.commit()
...
if __name__ == "__main__":
    ...
    Verif_PpiInsert_Window = QtWidgets.QMainWindow()
    ui = Ui_Verif_PpiInsert_Window('P-23/001')
    ui.setupUi(Verif_PpiInsert_Window)
    Verif_PpiInsert_Window.show()
    sys.exit(app.exec())