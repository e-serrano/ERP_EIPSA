            ...
            if material != '':
                ...
                # connect to the PostgreSQL server
                    ...
                    if material == 'Caudal':
                        ...
                        commands_tags = f" SELECT '', {self.column_id}, tag, num_order, description, dim_drawing FROM {self.table_name} WHERE num_order LIKE UPPER ('%%'||'{self.num_order_value}'||'%%') ORDER BY {self.column_id}"
...
#     Verif_Dim_DrawingInsertTag_Window = Ui_Verif_Dim_DrawingInsertTag_Window('P-23/001-S00','m.gil')
