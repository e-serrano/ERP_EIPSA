...
class Ui_Verif_Flange_Information_Window(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Verif_Flange_Information_Window):
        ...
        Verif_Flange_Information_Window.setStyleSheet(
    "QComboBox {\n"
    ...
    "}")
        ...
        self.tableInformation.horizontalHeader().setStyleSheet("QHeaderView::section {background-color: #33bdef; border: 1px solid; font-weight: bold; font-size: 10pt;}")
    ...
    def query_information(self):
        ...
        # execution of commands
            ...
            # fill the Qt Table with the query results
                ...
                if self.Facing_Flange.text() == 'RF':
                    self.image_path = r'\\ERP-EIPSA-DATOS\DATOS\Comunes\EIPSA-ERP\Resources\Plantillas planos\BRIDA RF VERIFICACION.png'
                elif self.Facing_Flange.text() == 'RTJ':
                    self.image_path = r'\\ERP-EIPSA-DATOS\DATOS\Comunes\EIPSA-ERP\Resources\Plantillas planos\BRIDA RTJ VERIFICACION.png'
                else:
                    self.image_path = None
