# Form implementation generated from reading ui file 'Verif_OF_DrawingInsertTag_Window.ui'
#
...
class Ui_Verif_OF_DrawingInsertTag_Window(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Verif_OF_DrawingInsertTag_Window):
        Verif_OF_DrawingInsertTag_Window.setObjectName("Verif_OF_DrawingInsertTag_Window")
        Verif_OF_DrawingInsertTag_Window.resize(400, 561)
        Verif_OF_DrawingInsertTag_Window.setMinimumSize(QtCore.QSize(1000, 675))
        # Verif_OF_DrawingInsertTag_Window.setMaximumSize(QtCore.QSize(800, 675))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Verif_OF_DrawingInsertTag_Window.setWindowIcon(icon)
        if self.username == 'm.gil':
            Verif_OF_DrawingInsertTag_Window.setStyleSheet("QWidget {\n"
    ...
    "    border-color: rgb(255, 255, 255);\n"
    "}")
        self.centralwidget = QtWidgets.QWidget(parent=Verif_OF_DrawingInsertTag_Window)
        ...
        Verif_OF_DrawingInsertTag_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Verif_OF_DrawingInsertTag_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 400, 22))
        self.menubar.setObjectName("menubar")
        Verif_OF_DrawingInsertTag_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Verif_OF_DrawingInsertTag_Window)
        self.statusbar.setObjectName("statusbar")
        Verif_OF_DrawingInsertTag_Window.setStatusBar(self.statusbar)
        ...
        Verif_OF_DrawingInsertTag_Window.setWindowFlag(QtCore.Qt.WindowType.WindowCloseButtonHint, False)

        self.retranslateUi(Verif_OF_DrawingInsertTag_Window)
        QtCore.QMetaObject.connectSlotsByName(Verif_OF_DrawingInsertTag_Window)

        self.num_order.setText(self.numorder)

        self.Button_Cancel.clicked.connect(Verif_OF_DrawingInsertTag_Window.close)
    ...
    def retranslateUi(self, Verif_OF_DrawingInsertTag_Window):
        _translate = QtCore.QCoreApplication.translate
        Verif_OF_DrawingInsertTag_Window.setWindowTitle(_translate("Verif_OF_DrawingInsertTag_Window", "Planos OF"))
        self.label_order.setText(_translate("Verif_OF_DrawingInsertTag_Window", "Nº Pedido:"))
        self.label_of_eq.setText(_translate("Verif_OF_DrawingInsertTag_Window", "Plano OF Equipo:"))
        self.label_of_sensor.setText(_translate("Verif_OF_DrawingInsertTag_Window", "Plano OF Sensor:"))
        self.Button_Cancel.setText(_translate("Verif_OF_DrawingInsertTag_Window", "Cancelar"))
        self.Button_Insert.setText(_translate("Verif_OF_DrawingInsertTag_Window", "Insertar"))
            ...
            if material != '':
                ...
                # connect to the PostgreSQL server
                    ...
                    if material == 'Caudal':
                        ...
                        commands_tags = f" SELECT '', {self.column_id}, tag, num_order, description, of_drawing FROM {self.table_name} WHERE num_order LIKE UPPER ('%%'||'{self.num_order_value}'||'%%') ORDER BY {self.column_id}"
                        self.num_columns = 6
                        column_headers = ['', 'ID', 'TAG', 'Nº Pedido', 'Tipo Equipo', 'OF Equipo']
                        self.label_of_sensor.setVisible(False)
                        self.of_sensor.setVisible(False)
                ...
                if len(id_list) == 0:
                    ...
                    # execution of commands
                        if of_sensor == '':
                            ...
                            for id_value in id_list:
                                commands_liquidtest = f"UPDATE {self.table_name} SET of_sensor_drawing = '{of_sensor}' WHERE {self.column_id} = {id_value}"
                                cur.execute(commands_liquidtest)
...
if __name__ == "__main__":
    ...
    Verif_OF_DrawingInsertTag_Window = Ui_Verif_OF_DrawingInsertTag_Window('P-24/026-S00', 'm.gil')
    Verif_OF_DrawingInsertTag_Window.show()
    sys.exit(app.exec())