# Form implementation generated from reading ui file 'Supplies_Warehouse_Window.ui'
#
...
class Ui_Supplies_Warehouse_Window(QtWidgets.QMainWindow):
    """
    UI class for the Offer Active window.
    """
    def __init__(self, username):
        """
        Initializes the Ui_Supplies_Warehouse_Window with the specified role.
        """
        super().__init__()
        self.username = username
        self.setupUi(self)

    def setupUi(self, Supplies_Warehouse_Window):
        """
        Sets up the user interface for the Supplies_Warehouse_Window.

        Args:
            Supplies_Warehouse_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        Supplies_Warehouse_Window.setObjectName("Supplies_Warehouse_Window")
        Supplies_Warehouse_Window.resize(400, 561)
        Supplies_Warehouse_Window.setMinimumSize(QtCore.QSize(1000, 675))
        # Supplies_Warehouse_Window.setMaximumSize(QtCore.QSize(600, 575))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Supplies_Warehouse_Window.setWindowIcon(icon)
    ...
    "    border-color: rgb(255, 255, 255);\n"
    "}")
        self.centralwidget = QtWidgets.QWidget(parent=Supplies_Warehouse_Window)
        ...
        self.tableSupplies.verticalHeader().setVisible(False)
        self.gridLayout_2.addWidget(self.tableSupplies, 1, 0, 1, 6)
        ...
        Supplies_Warehouse_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Supplies_Warehouse_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 400, 22))
        self.menubar.setObjectName("menubar")
        Supplies_Warehouse_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Supplies_Warehouse_Window)
        self.statusbar.setObjectName("statusbar")
        Supplies_Warehouse_Window.setStatusBar(self.statusbar)
        self.tableSupplies.verticalHeader().setVisible(True)
        self.tableSupplies.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Interactive)
        self.tableSupplies.horizontalHeader().setDefaultSectionSize(150)
        self.tableSupplies.horizontalHeader().setSectionResizeMode(0, QtWidgets.QHeaderView.ResizeMode.Stretch)
        ...
        self.tableSupplies.horizontalHeader().sectionDoubleClicked.connect(self.on_header_section_clicked)

        self.load_supplies()
        self.Position.textChanged.connect(self.position_table)

# Function to translate and updates the text of various UI elements
    def retranslateUi(self, Supplies_Warehouse_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        Supplies_Warehouse_Window.setWindowTitle(_translate("Supplies_Warehouse_Window", "Suministros"))
        item = self.tableSupplies.horizontalHeaderItem(0)
        item.setText(_translate("Supplies_Warehouse_Window", "Artículo"))
        item = self.tableSupplies.horizontalHeaderItem(1)
        item.setText(_translate("Supplies_Warehouse_Window", "Descripción"))
...
# Function to query supplies
    def load_supplies(self):
        ...
        # execution of commands
            ...
            self.tableSupplies.setRowCount(len(results))
            tablerow=0
...
# Function to move table to specific item by text search
    def position_table(self, num_order_tocheck = None):
        ...
        for i in range(self.tableSupplies.rowCount()):
            item = self.tableSupplies.item(i, 0)
...
if __name__ == "__main__":
    ...
    Supplies_Warehouse_Window = Ui_Supplies_Warehouse_Window('j.tena')
    Supplies_Warehouse_Window.show()
    sys.exit(app.exec())