# Form implementation generated from reading ui file 'TransactionsInvoice_Window.ui'
#
...
class Ui_TransactionsInvoice_Window(QtWidgets.QMainWindow):
    """
    UI class for the Transactions Invoice window.
    """
    def __init__(self):
        """
        Initializes the Ui_TransactionsInvoice_Window.
        """
        super().__init__()
        self.setupUi(self)

    def setupUi(self, TransactionsInvoice_Window):
        """
        Sets up the user interface for the TransactionsInvoice_Window.

        Args:
            TransactionsInvoice_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        TransactionsInvoice_Window.setObjectName("TransactionsInvoice_Window")
        TransactionsInvoice_Window.resize(845, 590)
        TransactionsInvoice_Window.setMinimumSize(QtCore.QSize(1000, 590))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath(os.path.join(basedir, "Resources/Iconos/icon.ico"))), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        TransactionsInvoice_Window.setWindowIcon(icon)
        TransactionsInvoice_Window.setStyleSheet("QWidget {\n"
...
"    border-color: rgb(255, 255, 255);\n"
"}")
        self.centralwidget = QtWidgets.QWidget(parent=TransactionsInvoice_Window)
...
"}")
        ...
        TransactionsInvoice_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=TransactionsInvoice_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 845, 22))
        self.menubar.setObjectName("menubar")
        TransactionsInvoice_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=TransactionsInvoice_Window)
        self.statusbar.setObjectName("statusbar")
        TransactionsInvoice_Window.setStatusBar(self.statusbar)
        self.tableQueryInvoice.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)

        self.retranslateUi(TransactionsInvoice_Window)
        QtCore.QMetaObject.connectSlotsByName(TransactionsInvoice_Window)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, TransactionsInvoice_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        TransactionsInvoice_Window.setWindowTitle(_translate("TransactionsInvoice_Window", "Datos Cobro-Pago"))
        self.Button_ExportExcel.setText(_translate("TransactionsInvoice_Window", "Exportar A Excel"))
        item = self.tableQueryInvoice.horizontalHeaderItem(0)
        item.setText(_translate("TransactionsInvoice_Window", "Cliente"))
        item = self.tableQueryInvoice.horizontalHeaderItem(1)
        item.setText(_translate("TransactionsInvoice_Window", "Nº Factura"))
        item = self.tableQueryInvoice.horizontalHeaderItem(2)
        item.setText(_translate("TransactionsInvoice_Window", "Fecha Factura"))
        item = self.tableQueryInvoice.horizontalHeaderItem(3)
        item.setText(_translate("TransactionsInvoice_Window", "Base Imponible"))
        item = self.tableQueryInvoice.horizontalHeaderItem(4)
        item.setText(_translate("TransactionsInvoice_Window", "IVA"))
        item = self.tableQueryInvoice.horizontalHeaderItem(5)
        item.setText(_translate("TransactionsInvoice_Window", "Total Fact."))
        item = self.tableQueryInvoice.horizontalHeaderItem(6)
        item.setText(_translate("TransactionsInvoice_Window", "Obs."))
        item = self.tableQueryInvoice.horizontalHeaderItem(7)
        item.setText(_translate("TransactionsInvoice_Window", "OK"))
        item = self.tableQueryInvoice.horizontalHeaderItem(8)
        item.setText(_translate("TransactionsInvoice_Window", "País Dest."))
        item = self.tableQueryInvoice.horizontalHeaderItem(9)
        item.setText(_translate("TransactionsInvoice_Window", "Ag. Int."))
        item = self.tableQueryInvoice.horizontalHeaderItem(10)
        item.setText(_translate("TransactionsInvoice_Window", "Ag. Int. Estado"))
        item = self.tableQueryInvoice.horizontalHeaderItem(11)
        item.setText(_translate("TransactionsInvoice_Window", "Ag. Int. Fecha"))
    ...
    def query_all_invoices(self):
        ...
        commands_queryinvoice = ("""
                        SELECT clients."name", invoice."num_invoice", TO_CHAR(invoice."date_invoice",'dd/MM/yyyy'), invoice."tax_base_amount",
                        invoice."iva", (invoice."tax_base_amount" + (invoice."tax_base_amount" * invoice."iva"/100)) AS TOTALFACT, invoice."obs_delivnote",
                        invoice."pay_date", dest_country."name", invoice."aginterm", invoice."aginterm_state", invoice."aginterm_ok"
                        ...
                        INNER JOIN purch_fact.destination_country AS dest_country ON invoice."id_dest_country" = dest_country."id"
                        ...
                        if item is not None:
                            if col in [2, 7, 11]:  # date column
                                ...
                                if date_str:  
                                    ...
                                    column_data.append('')
                            elif col in [3, 5]:  # currency columns
...
if __name__ == "__main__":
    ...
    TransactionsInvoice_Window = Ui_TransactionsInvoice_Window()
    TransactionsInvoice_Window.show()
    sys.exit(app.exec())
