...
from openpyxl.drawing.spreadsheet_drawing import AbsoluteAnchor, OneCellAnchor, AnchorMarker, TwoCellAnchor
    ...
    def __init__(self, numoffer, username, rev, project, delivery_term, delivery_time, validity, pay_term, testinspection, revchanges, notes):
        ...
        # Editing sheet NOTES
            ...
            if pay_term == "100_delivery":
                ...
                ws["B45"] = (
                    "50 % of the total amount of purchase order upon receipt of purchase order. Remaining 50% before be delivered according to Incoterms 2020, FCA (our facilities, Spain).\n"
                    "Payment method: bank transfer."
                )
                ws["B46"] = (
            ...
            for sheet in self.wb_commercial.sheetnames:
                if sheet not in sheets_confirmed:
                    sheet_to_delete = self.wb_commercial.get_sheet_by_name(sheet)
                    self.wb_commercial.remove_sheet(sheet_to_delete)
    ...
    def __init__(self, numoffer, username, rev, project, delivery_term, delivery_time, validity, pay_term, testinspection, revchanges, notes,):
        ...
        try:
            ...
            for value_type in df["value_type"].unique():
                ...
                if eq_type == "LEVEL GAUGE ELEMENTS DATA":
                    df_toexport = df_toexport.drop([
                            "float_material"],
                        axis=1,)
