        ...
        for element in self.id_list:
            ...
            if target_row is not None:
                if self.variable == "Caudal":
                    ...
                    ped_type_tag = self.model.data(self.model.index(target_row, 106))
                    ...
                    qty_orifice_flange = self.model.data(self.model.index(target_row, 71))
                    codefab_line_flange = self.model.data(self.model.index(target_row, 73))
                    qty_line_flange = self.model.data(self.model.index(target_row, 74))
                    codefab_gasket = self.model.data(self.model.index(target_row, 76))
                    qty_gasket = self.model.data(self.model.index(target_row, 77))
                    codefab_bolts = self.model.data(self.model.index(target_row, 79))
                    qty_bolts = self.model.data(self.model.index(target_row, 80))
                    codefab_plugs = self.model.data(self.model.index(target_row, 82))
                    qty_plugs = self.model.data(self.model.index(target_row, 83))
                    codefab_extractor = self.model.data(self.model.index(target_row, 85))
                    qty_extractor = self.model.data(self.model.index(target_row, 86))
                    codefab_plate = self.model.data(self.model.index(target_row, 88))
                    qty_plate = self.model.data(self.model.index(target_row, 89))
                    codefab_nipple = self.model.data(self.model.index(target_row, 91))
                    qty_nipple = self.model.data(self.model.index(target_row, 92))
                    codefab_handle = self.model.data(self.model.index(target_row, 94))
                    qty_handle = self.model.data(self.model.index(target_row, 95))
                    codefab_chring = self.model.data(self.model.index(target_row, 97))
                    qty_chring = self.model.data(self.model.index(target_row, 98))
                    codefab_tube = self.model.data(self.model.index(target_row, 100))
                    qty_tube = self.model.data(self.model.index(target_row, 101))
                    codefab_piece2 = self.model.data(self.model.index(target_row, 103))
                    qty_piece2 = self.model.data(self.model.index(target_row, 104))
                    ...
                    code_fab_equipment = self.model.data(self.model.index(target_row, 74))
                    codefab_bar = self.model.data(self.model.index(target_row, 77))
                    qty_bar = self.model.data(self.model.index(target_row, 78))
                    codefab_tube = self.model.data(self.model.index(target_row, 80))
                    qty_tube = self.model.data(self.model.index(target_row, 81))
                    ...
                    qty_sensor = self.model.data(self.model.index(target_row, 87))
                    codefab_head = self.model.data(self.model.index(target_row, 89))
                    qty_head = self.model.data(self.model.index(target_row, 90))
                    codefab_btb = self.model.data(self.model.index(target_row, 92))
                    qty_btb = self.model.data(self.model.index(target_row, 93))
                    ...
                    qty_spring = self.model.data(self.model.index(target_row, 99))
                    codefab_puntal = self.model.data(self.model.index(target_row, 101))
                    qty_puntal = self.model.data(self.model.index(target_row, 102))
                    codefab_plug = self.model.data(self.model.index(target_row, 104))
                    qty_plug = self.model.data(self.model.index(target_row, 105))
                    codefab_tw = self.model.data(self.model.index(target_row, 107))
                    qty_tw = self.model.data(self.model.index(target_row, 108))
                    codefab_cable = self.model.data(self.model.index(target_row, 110))
                    qty_cable = self.model.data(self.model.index(target_row, 111))
