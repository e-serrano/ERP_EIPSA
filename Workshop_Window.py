...
"}")
        ...
        self.tableWorkshop.setModel(self.proxy)
    ...
    # Getting the unique values for each column of the model
        ...
        self.Button_All.clicked.connect(self.query_all_whorkshop)
        self.tableWorkshop.setSortingEnabled(False)
        self.tableWorkshop.horizontalHeader().sectionClicked.connect(self.on_view_horizontalHeader_sectionClicked)
        self.model.dataChanged.connect(self.saveChanges)
...
# Function when header is clicked
    def on_view_horizontalHeader_sectionClicked(self, logicalIndex):
        ...
        self.signalMapper = QtCore.QSignalMapper(self.tableWorkshop)

        valuesUnique_view = []
        for row in range(self.tableWorkshop.model().rowCount()):
            index = self.tableWorkshop.model().index(row, self.logicalIndex)
        ...
        actionSortAscending = QtGui.QAction("Ordenar Ascendente", self.tableWorkshop)
        actionSortAscending.triggered.connect(self.on_actionSortAscending_triggered)
        self.menuValues.addAction(actionSortAscending)
        actionSortDescending = QtGui.QAction("Ordenar Descendente", self.tableWorkshop)
        ...
        actionDeleteFilterColumn = QtGui.QAction("Quitar Filtro", self.tableWorkshop)
        ...
        actionTextFilter = QtGui.QAction("Buscar...", self.tableWorkshop)
        ...
        accept_button = QtGui.QAction("ACEPTAR", self.tableWorkshop)
        accept_button.triggered.connect(self.menu_acceptbutton_triggered)

        cancel_button = QtGui.QAction("CANCELAR", self.tableWorkshop)
        ...
        headerPos = self.tableWorkshop.mapToGlobal(self.tableWorkshop.horizontalHeader().pos())        

        posY = headerPos.y() + self.tableWorkshop.horizontalHeader().height()
        scrollX = self.tableWorkshop.horizontalScrollBar().value()
        xInView = self.tableWorkshop.horizontalHeader().sectionViewportPosition(logicalIndex)
...
# Function to order column ascending
    def on_actionSortAscending_triggered(self):
        ...
        self.tableWorkshop.sortByColumn(sortColumn, sortOrder)
...
#     Workshop_Window = Ui_Workshop_Window(db)
