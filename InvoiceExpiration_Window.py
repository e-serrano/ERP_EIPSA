...
class Ui_ExpiringInvoice_Window(QtWidgets.QMainWindow):
    """
    UI class for the Expiring Invoice window.
    """
    def __init__(self):
        """
        Initializes the Ui_ExpiringInvoice_Window.
        """
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, ExpiringInvoice_Window):
        """
        Sets up the user interface for the ExpiringInvoice_Window.

        Args:
            ExpiringInvoice_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
