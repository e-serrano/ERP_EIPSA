...
class Ui_Workshop_Chemical_Products_Window(QtWidgets.QMainWindow):
    """
    ...
    def setupUi(self, Workshop_Chemical_Products_Window):
        """
        Sets up the user interface for the Workshop_Chemical_Products_Window.

        Args:
            Workshop_Chemical_Products_Window (QtWidgets.QMainWindow): The main window for the UI setup.
        """
        Workshop_Chemical_Products_Window.setObjectName("Workshop_Chemical_Products_Window")
        Workshop_Chemical_Products_Window.resize(790, 595)
        Workshop_Chemical_Products_Window.setMinimumSize(QtCore.QSize(790, 595))
        icon = QtGui.QIcon()
        ...
        Workshop_Chemical_Products_Window.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=Workshop_Chemical_Products_Window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 790, 22))
        self.menubar.setObjectName("menubar")
        Workshop_Chemical_Products_Window.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Workshop_Chemical_Products_Window)
        self.statusbar.setObjectName("statusbar")
        Workshop_Chemical_Products_Window.setStatusBar(self.statusbar)

        self.retranslateUi(Workshop_Chemical_Products_Window)
        QtCore.QMetaObject.connectSlotsByName(Workshop_Chemical_Products_Window)
...
# Function to translate and updates the text of various UI elements
    def retranslateUi(self, Workshop_Chemical_Products_Window):
        """
        Translates and updates the text of various UI elements.
        """
        _translate = QtCore.QCoreApplication.translate
        Workshop_Chemical_Products_Window.setWindowTitle(_translate("Workshop_Chemical_Products_Window", "Productos Químicos"))
...
# Function to load filtered table and setting in the window
    def query_equipment(self):
        ...
        self.model.setTable("verification.chemical_products_workshop")
    ...
    # Change all column names
        headers_names = ["ID", "Producto", "Fecha Compra", "Cantidad", "Fecha Fabricación", "Fecha Caducidad", "Colada", "Notas", "Foto", "Certificado"]
...
if __name__ == "__main__":
    ...
    Workshop_Chemical_Products_Window = Ui_Workshop_Chemical_Products_Window(db, 'm.gil')
    Workshop_Chemical_Products_Window.showMaximized()
    sys.exit(app.exec())