...
"}")
        ...
        try:
            ...
            tables_to_delete = ['PED_Welding_certificates', 'al_drawing_verification', 'calibers_workshop_revisions', 'calibration_thermoelements', 'delivnote_suppliers', 'dim_drawing_verification', 'flanges_verification',
